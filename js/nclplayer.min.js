...
!0,this.seek(this.area[this.area[a].id].beginTime),$(this.htmlPlayer).one("seeked",$.proxy(function(){this.parentContext.notify(this)},this))):this.parentContext.notify(this)),$(this.htmlPlayer).trigger("presentation.onBegin",[a]))};
