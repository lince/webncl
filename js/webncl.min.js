...
a+"] "+this.MESSAGES[a]+"\n"+b+": "+c.join(","))}};function WebNclPlayer(a,b){this.presentation={TIME_LIMIT:1E3,playerId:++WebNclPlayer.playerCount,playerDiv:b,getDivId:function(a,b){return"ncl"+this.playerId+(b||"")+"_"+(this.parser.referenceMap.instReuse[a]||a)},path:/[\/]*.+\//g.exec(a)[0],mediaPlayers:{"text/htm":{defaultPlayer:Html5Player},image:{defaultPlayer:Html5Player},audio:{defaultPlayer:Html5Player},video:{defaultPlayer:Html5Player},"text/css":void 0,"text/html":{defaultPlayer:Html5Player},"text/plain":{defaultPlayer:Html5Player},"application/x-ginga-NCLua":void 0,
"application/x-ginga-NCLet":void 0,"application/x-ginga-settings":{defaultPlayer:Html5Player},"text/xml":void 0},keyEvents:{}};this.presentation.bodyDiv="body"+this.presentation.playerId;this.presentation.settingsDiv="settings"+this.presentation.playerId;this.presentation.contextsDiv="contexts"+this.presentation.playerId;this.presentation.keys={CURSOR_UP:38,CURSOR_DOWN:40,CURSOR_LEFT:37,CURSOR_RIGHT:39,ENTER:13,RED:81,GREEN:87,YELLOW:69,BLUE:82,KEY_0:96,KEY_1:97,KEY_2:98,KEY_3:99,KEY_4:100,KEY_5:101,
KEY_6:102,KEY_7:103,KEY_8:104,KEY_9:105,BACK:90,EXIT:88,PLAY:67,STOP:86,PAUSE:66,RECORD:78,POWER:65,REWIND:83,EJECT:68};this.presentation.keys.allCodes=[13,37,38,39,40,81,87,69,82,96,97,98,99,100,101,102,103,104,105,90,88,67,86,66,78,65,83,68];$.ajax({type:"GET",url:a,dataType:"xml",success:$.proxy(function(a){this.execute(a)},this)})}
...
Html5Player.prototype.exec=function(a,b){this.popcornPlayer.exec(a,b)};Html5Player.prototype.start=function(){this.popcornPlayer.play()};Html5Player.prototype.stop=function(){this.p.checkType(["video","audio","image","text"])&&this.popcornPlayer.pause(0)};Html5Player.prototype.pause=function(){this.p.checkType(["video","audio","image","text"])&&this.popcornPlayer.pause()};Html5Player.prototype.resume=function(){this.p.checkType(["video","audio","image","text"])&&this.popcornPlayer.play()};
Html5Player.prototype.abort=function(){this.stop()};Html5Player.prototype.seek=function(a){if(this.p.checkType(["video","audio","image","text"]))try{this.popcornPlayer.currentTime(a)}catch(b){eval("$(this.htmlPlayer).one('loadedmetadata',$.proxy(function() {this.popcornPlayer.currentTime("+a+");},this));")}};
Html5Player.prototype.seekAndPlay=function(a){if(this.p.checkType(["video","audio"])){try{this.popcornPlayer.currentTime(a)}catch(b){eval("$(this.htmlPlayer).one('loadedmetadata',$.proxy(function() {this.popcornPlayer.currentTime("+a+");},this));")}$(this.htmlPlayer).one("seeked",$.proxy(function(){this.popcornPlayer.play()},this))}else this.p.checkType(["image","text"])&&this.popcornPlayer.currentTime(a)};MediaPlayer.prototype=new Player;function MediaPlayer(a,b){this.htmlPlayerBkg=this.htmlPlayer=this.type=this.region="";this.playerSettings=this.player=void 0;this.area=[];this.transIn=[];this.transOut=[];this.isPlaying=!1;this.isVisible=this.isStopped=!0;this.isFocused=!1;this.explicitDur=void 0;this.opacity=1;this.node=a;this.presentation=b.presentation;this.parentContext=b;this.divId=this.presentation.getDivId(a.id);this.create(a)}
...
ext:a._ext,url:this.presentation.path+a.src},id:this.divId,parentId:this.presentation.getDivId(a.id,"bkg"),createElement:$.proxy(this.createElement,this),checkType:$.proxy(this.checkType,this),media:{areas:this.area}},this.player=new (b[this.type][a._ext]||b[this.type].defaultPlayer)(this.playerSettings));$(this.htmlPlayerBkg).css("display","none");this.load(a.src);player.onEnded=$.proxy(function(){this.stop()},this);if(player.exec)for(i in this.area)this.area[i].end&&eval("this.player.exec(this.area[i].endTime,$.proxy(function() {if (this.area['"+
i+"'].started) {this.area['"+i+"'].started = false;$(this.htmlPlayer).trigger('stop',[this.area['"+i+"'].id]);} else {$(this.htmlPlayer).trigger('presentation.onEnd',[this.area['"+i+"'].id]); }},this));"),this.area[i].begin&&eval("this.player.exec(this.area[i].beginTime,$.proxy(function() {$(this.htmlPlayer).trigger('presentation.onBegin',[this.area['"+i+"'].id]);},this));");$(this.htmlPlayer).data("property",[]);if(a.descriptor)for(i in a.descriptor.region&&(this.setProperty("zIndex",a.descriptor.region.zIndex),
this.setProperty("width",a.descriptor.region.width),this.setProperty("height",a.descriptor.region.height),this.setProperty("bottom",a.descriptor.region.bottom),this.setProperty("top",a.descriptor.region.top),this.setProperty("right",a.descriptor.region.right),this.setProperty("left",a.descriptor.region.left),this.setProperty("title",a.descriptor.region.title)),a.descriptor.descriptorParam)this.setProperty(a.descriptor.descriptorParam[i].name,a.descriptor.descriptorParam[i].value);for(i in a.property)this.setProperty(a.property[i].name,
a.property[i].value);this.explicitDur&&this.player.exec&&this.player.exec(this.explicitDur,$.proxy(function(){this.stop()},this));this.bindEvents();$(this.htmlPlayer).data("player",this)}};MediaPlayer.prototype.load=function(a){a=this.presentation.path+a;this.player.load(a)};
...
MediaPlayer.prototype.start=function(a){this.isStopped&&(this.presentation.focusManager.enableKeys(this.htmlPlayer),this.presentation.focusManager.addMedia(this.node.descriptor.focusIndex,this.htmlPlayer),this.isPlaying=!0,this.isStopped=!1,this.show(),this.player.start(),a&&"area"==this.area[a]._type&&this.area[this.area[a].id].begin&&(this.area[this.area[a].id].started=!0,this.seek(this.area[this.area[a].id].beginTime)),$(this.htmlPlayer).trigger("presentation.onBegin",[a]))};
MediaPlayer.prototype.stop=function(a){this.isStopped||(this.presentation.focusManager.disableKeys(this.htmlPlayer),this.presentation.focusManager.removeMedia(this.node.descriptor.focusIndex,this.htmlPlayer),this.isPlaying=!1,this.isStopped=!0,this.hide(),this.player.stop(),$(this.htmlPlayer).trigger("presentation.onEnd",[a]))};MediaPlayer.prototype.pause=function(a){this.isPlaying&&(this.isStopped=this.isPlaying=!1,this.player.pause(),$(this.htmlPlayer).trigger("presentation.onPause",[a]))};
MediaPlayer.prototype.resume=function(a){!this.isStopped&&!this.isPlaying&&(this.isPlaying=!0,this.isStopped=!1,this.player.resume(),$(this.htmlPlayer).trigger("presentation.onResume",[a]))};MediaPlayer.prototype.abort=function(a){this.isStopped||(this.presentation.focusManager.removeMedia(this.node.descriptor.focusIndex,this.htmlPlayer),this.isPlaying=!1,this.isStopped=!0,this.hide(),this.player.abort(),$(this.htmlPlayer).trigger("presentation.onAbort",[a]))};MediaPlayer.prototype.seek=function(a){this.player.seek(a)};
MediaPlayer.prototype.seekAndPlay=function(a){this.isStopped&&this.player.seekAndPlay(a)};function Player(){this.create=function(){};this.start=function(){};this.stop=function(){};this.pause=function(){};this.resume=function(){};this.abort=function(){};this.seekAndPlay=function(){};this.selection=function(){}}
