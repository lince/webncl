...
ERR_DUPLICATED_ALIAS:215,ERR_INVALID_CONTEXT_REFERENCE:216,ERR_MEDIAPLAYER_METHOD_NOTFOUND:301,ERR_MEDIAPLAYER_NOPLAYER:302,MESSAGES:{100:"Atributo inv\u00e1lido",101:"Tag inv\u00e1lida",102:"Estrutura do cabe\u00e7alho inv\u00e1lida",103:"Dimens\u00f5es de regi\u00e3o inv\u00e1lidas",104:"zIndex duplicado",105:"Recurso n\u00e3o implementado ainda",201:"Atributo obrigat\u00f3rio faltando",202:"Atributo obrigat\u00f3rio faltando (um desses)",203:"Atributo dependente faltando",204:"Excesso de atributos repetidos",
205:"Tag obrigat\u00f3ria faltando",206:"Tag obrigat\u00f3ria faltando (uma dessas)",207:"Excesso de tags repetidas",208:"Excesso de tags (apenas uma permitida)",209:"Valor de atributo inv\u00e1lido",210:"Refer\u00eancia a ID inv\u00e1lido",211:"ID duplicado",212:"Extens\u00e3o de arquivo incompat\u00edvel com o MIMETYPE",213:"URI inv\u00e1lida",214:"Atributo duplicado",215:"Alias duplicado",216:"Objeto referenciado em outro contexto",301:"M\u00e9todo n\u00e3o encontrado no media player",302:"Nenhum player foi definido para este mime type/extens\u00e3o"},
abort:!1,error:function(a,b,c){console.error("["+a+"] "+this.MESSAGES[a]+"\n"+b+": "+c.join(","));this.abort=!0},warning:function(a,b,c){console.warn("["+a+"] "+this.MESSAGES[a]+"\n"+b+": "+c.join(","))}};function Timer(a,b,c){c&&(this.manager=c);this.callback=b;this.timeLeft=a;this.id=this.startTime=null;this.timeout=function(){this.manager&&this.manager.remove(this);this.callback()};this.resume=function(){this.startTime=new Date;this.id=setTimeout($.proxy(function(){this.timeout()},this),this.timeLeft)};this.pause=function(){clearTimeout(this.id);this.timeLeft-=new Date-this.startTime};this.stop=function(){clearTimeout(this.id)};this.resume()}
function TimerManager(){this.timers=[];this.add=function(a,b){this.timers.push(new Timer(a,b,this))};this.remove=function(a){this.timers.splice(this.timers.indexOf(a),1)};this.pauseAll=function(){for(i in this.timers)this.timers[i].pause()};this.resumeAll=function(){for(i in this.timers)this.timers[i].resume()};this.stopAll=function(){for(i in this.timers)this.timers[i].stop();this.timers=[]}};function WebNclPlayer(a,b){var c=/[\/]*.+\//g;this.div=b;this.presentation={readyToPlay:!1,playRequested:!1,TIME_LIMIT:1E3,playerId:++WebNclPlayer.playerCount,playerDiv:b,getDivId:function(a,b){return"ncl"+this.playerId+(b||"")+"_"+(this.parser.referenceMap.instReuse[a]||a)},path:a&&c.exec(a)[0]||"",mediaPlayers:{"text/htm":{defaultPlayer:Html5Player},image:{defaultPlayer:Html5Player},audio:{defaultPlayer:Html5Player},video:{defaultPlayer:Html5Player},"text/css":void 0,"text/html":{defaultPlayer:Html5Player},
"text/plain":{defaultPlayer:Html5Player},"application/x-ginga-NCLua":void 0,"application/x-ginga-NCLet":void 0,"application/x-ginga-settings":{defaultPlayer:Html5Player},"text/xml":void 0},keyEvents:{}};this.presentation.bodyDiv="body"+this.presentation.playerId;this.presentation.settingsDiv="settings"+this.presentation.playerId;this.presentation.contextsDiv="contexts"+this.presentation.playerId;this.presentation.start=function(){this.readyToPlay?this.context.start():this.playRequested=!0};this.presentation.pause=
function(){this.context.pause()};this.presentation.resume=function(){this.context.resume()};this.presentation.abort=function(){this.context.abort()};this.presentation.stop=function(){this.context.stop();this.playRequested=!1};this.presentation.keys={CURSOR_UP:38,CURSOR_DOWN:40,CURSOR_LEFT:37,CURSOR_RIGHT:39,ENTER:13,RED:81,GREEN:87,YELLOW:69,BLUE:82,KEY_0:96,KEY_1:97,KEY_2:98,KEY_3:99,KEY_4:100,KEY_5:101,KEY_6:102,KEY_7:103,KEY_8:104,KEY_9:105,BACK:90,EXIT:88,PLAY:67,STOP:86,PAUSE:66,RECORD:78,POWER:65,
REWIND:83,EJECT:68};this.presentation.keys.allCodes=[13,37,38,39,40,81,87,69,82,96,97,98,99,100,101,102,103,104,105,90,88,67,86,66,78,65,83,68];a?$.ajax({type:"GET",url:a,dataType:"xml",success:$.proxy(function(a){this.execute(a)},this)}):(a=document.URL.split("/"),a=a[a.length-1],$.ajax({type:"GET",url:a,dataType:"text",success:$.proxy(function(a){this.execute($($.parseXML(a)).find("#"+this.div)[0])},this)}))}
...
this.presentation.readyToPlay=!0;this.presentation.playRequested&&this.presentation.context.start()};
...
b.height-c.bottom-c.height:0:null!=c.bottom?(c.top=0,c.height=b.height-c.bottom):(c.top=0,c.height=b.height);d.left=b.left+c.left;d.top=b.top+c.top;d.width=c.width;d.height=c.height;a.left=d.left+"px";a.top=d.top+"px";a.width=d.width+"px";a.height=d.height+"px";a.right=null;a.bottom=null;for(i in a.region)this.fixRegionBounds(a.region[i],d)};WebNclPlayer.prototype.triggerEvent=function(a,b,c){$("#"+this.presentation.getDivId(b)).trigger(a,[c])};WebNclPlayer.playerCount=0;
$(document).ready(function(){var a="";$("nclplayer").each(function(){var b=$(this).attr("src"),c=$(this).attr("id"),d=$(this).attr("autoplay");this.outerHTML='<div id="'+c+'" class="nclPlayer_'+c+'"> </div>';a+=".nclPlayer_"+c+" {\tposition: relative;\tleft: "+($(this).attr("left")||"0px")+";\ttop: "+($(this).attr("top")||"0px")+";\twidth: "+($(this).attr("width")||"854px")+";\theight: "+($(this).attr("height")||"480px")+";}";webNclPlayers.push(new WebNclPlayer(b,c));d&&webNclPlayers[webNclPlayers.length-
1].presentation.start()});a+=".context, #contexts, #settings {\tdisplay: none;}.player {\tposition: absolute;\tleft: 0px;\ttop: 0px;\toverflow: hidden;\tdisplay: inline;\t-o-object-position: 0 0;}.playerBkg {\tposition: absolute;\toverflow: hidden;\tdisplay: none;}";$("<style>").text(a).appendTo("head")});webNclPlayers=[];function FocusManager(a){this.presentation=a;var a=a.ncl.head.descriptorBase.descriptor,b=[],c;for(c in a){var d=a[c];d.focusIndex&&(b.push(d.focusIndex),this.descriptors[d.focusIndex]={self:d,mediaArray:[]})}this.bindKeyDown()}
...
FocusManager.prototype.keyEvent=function(a){this.triggerKeyEvents(a);if(this.currentFocusIndex){currentDescriptor=this.descriptors[this.currentFocusIndex];var b=this.presentation.keys;switch(a){case b.CURSOR_UP:currentDescriptor.self.moveUp&&this.setCurrentFocus(currentDescriptor.self.moveUp.focusIndex);break;case b.CURSOR_DOWN:currentDescriptor.self.moveDown&&this.setCurrentFocus(currentDescriptor.self.moveDown.focusIndex);break;case b.CURSOR_LEFT:currentDescriptor.self.moveLeft&&this.setCurrentFocus(currentDescriptor.self.moveLeft.focusIndex);
break;case b.CURSOR_RIGHT:currentDescriptor.self.moveRight&&this.setCurrentFocus(currentDescriptor.self.moveRight.focusIndex);break;case b.ENTER:for(var c in currentDescriptor.mediaArray)currentMedia=currentDescriptor.mediaArray[c],$(currentMedia).trigger("selection.onSelection")}}};
FocusManager.prototype.bindMouseEvents=function(a,b){$(b).css("cursor","pointer");$(b).on("click",$.proxy(function(a){1==a.which&&this.keyEvent(this.presentation.keys.ENTER)},this));$(b).on("mouseover",{focusIndex:a},$.proxy(function(a){this.setCurrentFocus(a.data.focusIndex)},this))};FocusManager.prototype.unbindMouseEvents=function(a){$(a).off("click");$(a).off("mouseover");$(a).css("cursor","default")};
...
!1;this.last=0;this.__verifyAssessmentStatements()&&this.__executeActions()}}break;case NclPlayer.listenerType.OR:(new Date).valueOf()-this.last.valueOf()>this.presentation.TIME_LIMIT&&(this.last=new Date,this.__executeActions())}};
...
SystemSettings.prototype.setPropertyValue=function(a,b){if(a in this.settings)this.settings[a]=b;else if(a in this.setMap)this.setMap[a](b);else return!1;return!0};SystemSettings.prototype.getPropertyValue=function(a){return a in this.settings?this.settings[a]:a in this.setMap?this.getMap[a]():""};Parser.isNotArray="ncl,head,body,importedDocumentBase,ruleBase,transitionBase,descriptorBase,connectorBase,defaultDescriptor,valueAssessment,defaultComponent".split(",");
...
function ContextPlayer(a,b){this.timerManager=new TimerManager;this.synchronizedPlayers=[];this.loadingPlayers=0;this.handlers={};this.node=a;this.media=[];this.context=[];this.port=[];this.pausedMediaList=[];this.pausedContextList=[];this.isCreated=!1;this.htmlPlayer="";this.isPlaying=!1;this.isStopped=!0;this.presentation=b;this.htmlPlayer=a.id?b.getDivId(a.id):b.bodyDiv;$("#"+b.contextsDiv).append("<div class='context' id='"+this.htmlPlayer+"'></div>");this.htmlPlayer="#"+this.htmlPlayer;$(this.htmlPlayer).data("player",
this);$(this.htmlPlayer).data("property",[]);this.bindEvents()}ContextPlayer.prototype.eventType={onBegin:"presentation",onEnd:"presentation",onAbort:"presentation",onPause:"presentation",onResume:"presentation",onSelection:"selection",onBeginAttribution:"attribution",onEndAttribution:"attribution"};ContextPlayer.prototype.syncPlayer=function(a){this.synchronizedPlayers.push(a.popcornPlayer);this.loadingPlayers++};
ContextPlayer.prototype.notify=function(a){if(a)if(2<=a.popcornPlayer.readyState())this.notify();else $(a.htmlPlayer).one("canplaythrough",$.proxy(function(){this.notify()},this));else if(0==--this.loadingPlayers)for(i in this.synchronizedPlayers)this.synchronizedPlayers[i].play()};
...
break;case "media":(nodeInterface=a["interface"])?this.media[a.component.id].start(nodeInterface):this.media[a.component.id].start()}};ContextPlayer.prototype.stop=function(a){if(!this.isStopped){this.isPlaying=!1;this.isStopped=!0;for(i in this.context)this.context[i].stop();for(i in this.media)this.media[i].stop();this.pausedMediaList=[];this.pausedContextList=[];$(this.htmlPlayer).trigger("presentation.onEnd",[a]);this.timerManager.stopAll()}};
ContextPlayer.prototype.pause=function(a){if(this.isPlaying){this.isStopped=this.isPlaying=!1;for(i in this.context)this.context[i].isPlaying&&(this.pausedContextList.push(i),this.context[i].pause());for(i in this.media)this.media[i].isPlaying&&(this.pausedMediaList.push(i),this.media[i].pause());$(this.htmlPlayer).trigger("presentation.onPause",[a]);this.timerManager.pauseAll()}};
ContextPlayer.prototype.resume=function(a){if(!this.isPlaying&&!this.isStopped){this.isPlaying=!0;this.isStopped=!1;for(i in this.pausedContextList)this.context[this.pausedContextList[i]].resume();for(i in this.pausedMediaList)this.media[this.pausedMediaList[i]].resume();this.pausedContextList=[];this.pausedMediaList=[];$(this.htmlPlayer).trigger("presentation.onResume",[a]);this.timerManager.resumeAll()}};
ContextPlayer.prototype.abort=function(a){if(!this.isStopped){this.isPlaying=!1;this.isStopped=!0;for(i in this.context)this.context[i].abort();for(i in this.media)this.media[i].abort();this.pausedMediaList=[];this.pausedContextList=[];$(this.htmlPlayer).trigger("presentation.onAbort",[a]);this.timerManager.stopAll()}};ContextPlayer.isVariable=function(a){return"$"==a.substring(0,1)};
ContextPlayer.createLocalParamMap=function(a){var b={};for(i in a)currentBindParam=a[i],b["$"+currentBindParam.name]=currentBindParam.value;return b};ContextPlayer.executeTriggerArray=function(a){for(var b;void 0!=(b=a.shift());)$(b[0]).trigger(b[1],b[2])};
ContextPlayer.prototype.bindLinks=function(){var a=this.node.port,b=this.node.link,c=this.handlers,d;for(d in a){var e=a[d],f=e["interface"]||void 0;if("media"==e.component._type&&f)console.warn("Eventos de atribuicao para propriedades referenciadas por portas nao foi implementado");else{var f="#"+this.presentation.getDivId(e.component.id),g=e.id,o;for(o in this.eventType){var h=this.eventType[o];if("attribution"!=h){var m=[h,o].join(".");$(f).on(m,{contextElement:this.htmlPlayer,interfaceId:g,eventName:m},
function(a){var b=$.Event(a.data.eventName);b.which=a.which;$(a.data.contextElement).trigger(b,[a.data.interfaceId])})}}}}for(d in b){var a=b[d],k=a.xconnector,f={},g={},m=0,r="par",j=k.simpleCondition,s={},t={},l=[];if(k.connectorParam)for(d in k.connectorParam)currentConnectorParam=k.connectorParam[d],s["$"+currentConnectorParam.name]="";if(k.compoundCondition)for(d in j=k.compoundCondition[0].simpleCondition,1<j.length&&(m=Listener.listenerType[k.compoundCondition[0].operator.toUpperCase()]),k.compoundCondition[0].assessmentStatement)for(o in h=
k.compoundCondition[0].assessmentStatement[d],h.attributeAssessment)e=h.attributeAssessment[o],"attribution"==e.eventType&&(!e.attributeType||"nodeProperty"==e.attributeType?t[e.role]={bindComponent:"",bindInterface:"",operator:h.comparator,value:h.valueAssessment.value,variable:ContextPlayer.isVariable(h.valueAssessment.value)}:console.warn("Eventos de tipos diferentes de attribution nao foram implementados para elementos do tipo AttributeAssessment"));for(o in t)l.push(t[o]);for(d in j){var h=j[d],
e=!1,p="",q=!1;"onSelection"==h.role&&h.key&&(ContextPlayer.isVariable(h.key)&&(e=!0),p=h.key,q=!0);g[h.role]={bindComponent:"",bindInterface:null,eventType:this.eventType[h.role],flag:!1,keyUseVariable:e,keyDefaultValue:p,useKey:q}}h=k.simpleAction;k.compoundAction&&(r=k.compoundAction[0].operator.toLowerCase(),h=k.compoundAction[0].simpleAction);for(d in h)j=h[d],"set"==j.role?(k=!1,e="",j.value&&(ContextPlayer.isVariable(j.value)&&(k=!0),e=j.value),f[j.role]={binds:[],qualifier:h[d].qualifier,
actionUseVariable:k,actionDefaultValue:e}):f[j.role]={binds:[],qualifier:h[d].qualifier};r=new Listener(m,r,f,g,l,this.presentation);if(a.linkParam)for(d in a.linkParam)currentLinkParam=a.linkParam[d],s["$"+currentLinkParam.name]=currentLinkParam.value;for(d in a.bind)if(l=a.bind[d],p=l.component.id,m="#"+this.presentation.getDivId(p),k=l["interface"],f[l.role])h=null,j=f[l.role],"set"==l.role&&(j.actionUseVariable?(n=ContextPlayer.createLocalParamMap(l.bindParam),h=n[j.actionDefaultValue]?n[j.actionDefaultValue]:
s[j.actionDefaultValue]):h=j.actionDefaultValue),j.binds.push({bindComponent:m,bindInterface:k,value:h});else if(g[l.role]){e=g[l.role];e.bindComponent=m;e.bindInterface=k;j=m;h=this.eventType[l.role];m=l.role;h=[h,m].join(".");p=[p,h].join(".");q=h+".triggerArray";if(e.useKey){var n=ContextPlayer.createLocalParamMap(l.bindParam);e.keyDefaultValue=n[e.keyDefaultValue]||s[e.keyDefaultValue];n=e.keyDefaultValue;$.isNumeric(n)&&(n="KEY_"+n);n in this.presentation.keys&&(e.keyDefaultValue=this.presentation.keys[n]);
...
n[currentAssessment.value]:s[currentAssessment.value])}};function Html5Player(a){this.p=a;this.popcornPlayer=void 0;this.htmlPlayer="#"+a.id;this.onEnded=void 0;switch(a.source.type.split("/")[0]){case "video":a.createElement("<video class='player' poster='images/loading.gif' id='"+a.id+"'></video>");break;case "audio":a.createElement("<audio class='player' id='"+a.id+"'></audio>");break;case "image":a.createElement("<img class='player' id='"+a.id+"'></img>");break;case "application":switch(a.source.type){case "application/x-ginga-settings":a.createElement("<div class='player' id='"+
a.id+"'></div>");break;case "application/x-ginga-NCLua":Debugger.warning(Debugger.WARN_NOT_IMPLEMENTED_YET,"media",[a.source.type]);break;case "application/x-ginga-NCLet":Debugger.warning(Debugger.WARN_NOT_IMPLEMENTED_YET,"media",[a.source.type]);break;case "application/x-ginga-time":Debugger.warning(Debugger.WARN_NOT_IMPLEMENTED_YET,"media",[a.source.type])}break;case "text":switch(a.source.type){case "text/plain":case "text/html":a.createElement("<div class='player' id='"+a.id+"'></div>");break;
case "text/css":Debugger.warning(Debugger.WARN_NOT_IMPLEMENTED_YET,"media",[a.source.type]);break;case "text/xml":Debugger.warning(Debugger.WARN_NOT_IMPLEMENTED_YET,"media",[a.source.type])}}if(a.checkType(["video","audio"])){do this.popcornPlayer=new Popcorn(this.htmlPlayer);while(!this.popcornPlayer)}else if(a.checkType(["image","text"])){do Popcorn.player("baseplayer"),this.popcornPlayer=new Popcorn.baseplayer(this.htmlPlayer);while(!this.popcornPlayer)}$(this.htmlPlayer).on("ended",$.proxy(function(){if(this.onEnded)this.onEnded()},
this))}Html5Player.prototype.load=function(a){$(this.htmlPlayer).empty();switch(this.p.source.type.split("/")[0]){case "video":$(this.htmlPlayer).append("<source src='"+a+"'></source>");break;case "audio":$(this.htmlPlayer).append("<source src='"+a+"'></source>");break;case "image":$(this.htmlPlayer).attr("src",a);break;case "text":this.checkType(["text/plain","text/html"])&&$.ajax({type:"GET",url:a,dataType:"text",success:$.proxy(function(a){$(this.htmlPlayer).append(a)},this)})}};
Html5Player.prototype.exec=function(a,b){this.popcornPlayer&&this.popcornPlayer.cue(a,b)};Html5Player.prototype.start=function(){this.popcornPlayer&&this.popcornPlayer.play()};Html5Player.prototype.stop=function(){this.popcornPlayer&&this.popcornPlayer.pause(0)};Html5Player.prototype.pause=function(){this.popcornPlayer&&this.popcornPlayer.pause()};Html5Player.prototype.resume=function(){this.popcornPlayer&&this.popcornPlayer.play()};Html5Player.prototype.abort=function(){this.stop()};
Html5Player.prototype.seek=function(a){if(this.popcornPlayer)try{this.popcornPlayer.currentTime(a)}catch(b){eval("$(this.htmlPlayer).one('loadedmetadata',$.proxy(function() {this.popcornPlayer.currentTime("+a+");},this));")}};
Html5Player.prototype.seekAndPlay=function(a){if(this.p.checkType(["video","audio"])){try{this.popcornPlayer.currentTime(a)}catch(b){eval("$(this.htmlPlayer).one('loadedmetadata',$.proxy(function() {this.popcornPlayer.currentTime("+a+");},this));")}$(this.htmlPlayer).one("seeked",$.proxy(function(){this.popcornPlayer.play()},this))}else this.p.checkType(["image","text"])&&this.popcornPlayer.currentTime(a)};MediaPlayer.prototype=new Player;function MediaPlayer(a,b){this.htmlPlayerBkg=this.htmlPlayer=this.type=this.region="";this.playerSettings=this.playerName=this.player=void 0;this.area=[];this.transIn=[];this.transOut=[];this.isPlaying=!1;this.isVisible=this.isStopped=!0;this.isFocused=!1;this.explicitDur=void 0;this.opacity=1;this.node=a;this.presentation=b.presentation;this.parentContext=b;this.divId=this.presentation.getDivId(a.id);this.create(a)}
...
MediaPlayer.prototype.create=function(a){a.descriptor&&(this.transIn=a.descriptor.transIn,this.transOut=a.descriptor.transOut,a.descriptor.explicitDur&&(vector=a.descriptor.explicitDur.split("s"),this.explicitDur=vector[0]));for(i in a.area)this.area[a.area[i].id]=a.area[i],a.area[i].begin&&(this.area[a.area[i].id].beginTime=parseInt(a.area[i].begin.split("s")[0])),a.area[i].end&&(this.area[a.area[i].id].endTime=parseInt(a.area[i].end.split("s")[0]),this.area[a.area[i].id].started=!1);if(a.type)this.type=
a.type;else{var b=a.src.split(".");this.type=this.mediaTypes[b[b.length-1]]}this.htmlPlayer="#"+this.divId;this.htmlPlayerBkg="#"+this.presentation.getDivId(a.id,"bkg");this.region=this.checkType(["application"])?"#"+this.presentation.settingsDiv:"#"+this.presentation.playerDiv;if(!(a.refer&&"new"!=a.instance)){$(this.region).append("<div class='playerBkg' id='"+this.presentation.getDivId(a.id,"bkg")+"'></div>");b=this.presentation.mediaPlayers;b[this.type]?(this.playerSettings={source:{type:this.type,
ext:a._ext,url:this.presentation.path+a.src},id:this.divId,parentId:this.presentation.getDivId(a.id,"bkg"),createElement:$.proxy(this.createElement,this),checkType:$.proxy(this.checkType,this),media:{areas:this.area}},(b=b[this.type][a._ext]||b[this.type].defaultPlayer)?(this.player=new b(this.playerSettings),this.playerName=b.name):(Debugger.error(Debugger.ERR_MEDIAPLAYER_NOPLAYER,this.type,["no defaultPlayer or extension player"]),this.player={})):(Debugger.error(Debugger.ERR_MEDIAPLAYER_NOPLAYER,
this.type),this.player={});$(this.htmlPlayerBkg).css("display","none");this.load(a.src);this.player.onEnded=$.proxy(function(){this.stop()},this);if(this.player.exec)for(i in this.area)this.area[i].end&&eval("this.player.exec(this.area[i].endTime,$.proxy(function() {if (this.area['"+i+"'].started) {this.area['"+i+"'].started = false;$(this.htmlPlayer).trigger('stop',[this.area['"+i+"'].id]);} else {$(this.htmlPlayer).trigger('presentation.onEnd',[this.area['"+i+"'].id]); }},this));"),this.area[i].begin&&
eval("this.player.exec(this.area[i].beginTime,$.proxy(function() {$(this.htmlPlayer).trigger('presentation.onBegin',[this.area['"+i+"'].id]);},this));");$(this.htmlPlayer).data("property",[]);if(a.descriptor)for(i in a.descriptor.region&&(this.setProperty("zIndex",a.descriptor.region.zIndex),this.setProperty("width",a.descriptor.region.width),this.setProperty("height",a.descriptor.region.height),this.setProperty("bottom",a.descriptor.region.bottom),this.setProperty("top",a.descriptor.region.top),
this.setProperty("right",a.descriptor.region.right),this.setProperty("left",a.descriptor.region.left),this.setProperty("title",a.descriptor.region.title)),a.descriptor.descriptorParam)this.setProperty(a.descriptor.descriptorParam[i].name,a.descriptor.descriptorParam[i].value);for(i in a.property){var b=a.property[i].name,c=a.property[i].value;c&&("width"==b||"height"==b?c=this.__fixPercentageSize(b,c):"bounds"==b&&(c=c.split(","),c[2]=this.__fixPercentageSize("width",c[2]),c[3]=this.__fixPercentageSize("height",
c[3]),c=c.join()),this.setProperty(b,c))}this.explicitDur&&this.player.exec&&this.player.exec(this.explicitDur,$.proxy(function(){this.stop()},this));this.bindEvents();$(this.htmlPlayer).data("player",this)}};
MediaPlayer.prototype.__fixPercentageSize=function(a,b){if("width"==a||"height"==a){var c=b.split("%");if(1<c.length){var d=parseInt($("#"+this.presentation.playerDiv).css(a).split("px")[0]),e;if(this.node.descriptor&&this.node.descriptor.region&&this.node.descriptor.region._parent){var f=this.node.descriptor.region._parent;"width"==a?e=f.width?f.width:d:"height"==a&&(e=f.height?f.height:d)}else e=d;return(parseInt(e)*parseFloat(c[0])/100).toString()}}return b};
MediaPlayer.prototype.load=function(a){a=this.presentation.path+a;this.player.load?this.player.load(a):Debugger.error(Debugger.ERR_MEDIAPLAYER_METHOD_NOTFOUND,this.playerName,["load",a])};
...
MediaPlayer.prototype.start=function(a){this.isStopped&&(this.presentation.focusManager.enableKeys(this.htmlPlayer),this.node.descriptor&&this.presentation.focusManager.addMedia(this.node.descriptor.focusIndex,this.htmlPlayer),this.isPlaying=!0,this.isStopped=!1,this.show(),this.player.start?this.player.start():Debugger.error(Debugger.ERR_MEDIAPLAYER_METHOD_NOTFOUND,this.playerName,["start",a]),a&&"area"==this.area[a]._type&&this.area[this.area[a].id].begin&&(this.area[this.area[a].id].started=!0,
this.seek(this.area[this.area[a].id].beginTime)),$(this.htmlPlayer).trigger("presentation.onBegin",[a]))};
MediaPlayer.prototype.stop=function(a){this.isStopped||(this.presentation.focusManager.disableKeys(this.htmlPlayer),this.node.descriptor&&this.presentation.focusManager.removeMedia(this.node.descriptor.focusIndex,this.htmlPlayer),this.isPlaying=!1,this.isStopped=!0,this.hide(),this.player.stop?this.player.stop():Debugger.error(Debugger.ERR_MEDIAPLAYER_METHOD_NOTFOUND,this.playerName,["stop",a]),$(this.htmlPlayer).trigger("presentation.onEnd",[a]))};
MediaPlayer.prototype.pause=function(a){this.isPlaying&&(this.isStopped=this.isPlaying=!1,this.player.pause?this.player.pause():Debugger.error(Debugger.ERR_MEDIAPLAYER_METHOD_NOTFOUND,this.playerName,["pause",a]),$(this.htmlPlayer).trigger("presentation.onPause",[a]))};
MediaPlayer.prototype.resume=function(a){!this.isStopped&&!this.isPlaying&&(this.isPlaying=!0,this.isStopped=!1,this.player.resume?this.player.resume():Debugger.error(Debugger.ERR_MEDIAPLAYER_METHOD_NOTFOUND,this.playerName,["resume",a]),$(this.htmlPlayer).trigger("presentation.onResume",[a]))};
MediaPlayer.prototype.abort=function(a){this.isStopped||(this.node.descriptor&&this.presentation.focusManager.removeMedia(this.node.descriptor.focusIndex,this.htmlPlayer),this.isPlaying=!1,this.isStopped=!0,this.hide(),this.player.abort?this.player.abort():Debugger.error(Debugger.ERR_MEDIAPLAYER_METHOD_NOTFOUND,this.playerName,["abort",a]),$(this.htmlPlayer).trigger("presentation.onAbort",[a]))};
MediaPlayer.prototype.seek=function(a){this.player.seek?this.player.seek(a):Debugger.error(Debugger.ERR_MEDIAPLAYER_METHOD_NOTFOUND,this.playerName,["seek",a])};MediaPlayer.prototype.seekAndPlay=function(a){this.isStopped&&(this.player.seekAndPlay?this.player.seekAndPlay(a):Debugger.error(Debugger.ERR_MEDIAPLAYER_METHOD_NOTFOUND,this.playerName,["seekAndPlay",a]))};function Player(){this.create=function(){};this.start=function(){};this.stop=function(){};this.pause=function(){};this.resume=function(){};this.abort=function(){};this.seekAndPlay=function(){};this.selection=function(){}}
...
Player.prototype.setProperty=function(a,b){$(this.htmlPlayer).trigger("attribution.onBeginAttribution",[a]);var c=$(this.htmlPlayer).data("property");c[a]=b?b:"";$(this.htmlPlayer).data("property",c);c=void 0;this.player&&this.player.propertyMap&&(c=this.player.propertyMap[a]);if(!c&&null!=b)switch(a){case "top":case "left":case "bottom":case "right":$(this.htmlPlayerBkg).css(a,b);break;case "height":case "width":var d=b.split("%");if(1<d.length)var e=$(this.htmlPlayerBkg).css(a),b=parseInt(parseInt(e)*
parseFloat(d[0])/100);$(this.htmlPlayer).css(a,b);$(this.htmlPlayerBkg).css(a,b);break;case "location":b.split(",");this.setProperty("left",d[0]);this.setProperty("top",d[1]);return;case "size":b.split(",");this.setProperty("width",d[0]);this.setProperty("height",d[1]);return;case "bounds":d=b.split(",");this.setProperty("left",d[0]);this.setProperty("top",d[1]);this.setProperty("width",d[2]);this.setProperty("height",d[3]);return;case "zIndex":$(this.htmlPlayer).css("z-index",b);$(this.htmlPlayerBkg).css("z-index",
b);break;case "soundLevel":this.checkType(["video","audio"])&&(d=b.split("%"),1<d.length&&(b=d[0]/100),this.popcornPlayer.volume(b));break;case "balanceLevel":case "bassLevel":case "trebleLevel":d=b.split("%");1<d.length&&(b=d[0]/100);Debugger.warning(Debugger.WARN_NOT_IMPLEMENTED_YET,"setProperty",[a]);break;case "background":$(this.htmlPlayerBkg).css("background-color",b);break;case "transparency":d=b.split("%");b=1<d.length?parseInt(d[0])/100:parseFloat(d[0]);this.opacity=1-b;$(this.htmlPlayer).css("opacity",
this.opacity);break;case "visible":(this.isVisible="true"==b?!0:!1)?(this.node.descriptor&&this.presentation.focusManager.addMedia(this.node.descriptor.focusIndex,this.htmlPlayer),$(this.htmlPlayerBkg).css("display","inline")):(this.node.descriptor&&this.presentation.focusManager.removeMedia(this.node.descriptor.focusIndex,this.htmlPlayer),$(this.htmlPlayerBkg).css("display","none"));break;case "scroll":Debugger.warning(Debugger.WARN_NOT_IMPLEMENTED_YET,"setProperty",[a]);break;case "fit":"meetBest"==
b&&Debugger.warning(Debugger.WARN_NOT_IMPLEMENTED_YET,"setProperty",[a]);console.log("Property 'fit' works only on Opera 10.6+");$(this.htmlPlayer).css("-o-object-fit",{fill:"fill",hidden:"none",meet:"contain",meetBest:"scaleDown",slice:"cover"}[b]);break;case "style":Debugger.warning(Debugger.WARN_NOT_IMPLEMENTED_YET,"setProperty",[a]);break;case "fontColor":$(this.htmlPlayer).css("color",b);break;case "fontFamily":$(this.htmlPlayer).css("font-family",b);break;case "fontStyle":$(this.htmlPlayer).css("font-style",
b);break;case "fontSize":$(this.htmlPlayer).css("font-size",b);break;case "fontVariant":$(this.htmlPlayer).css("font-variant",b);break;case "fontWeight":$(this.htmlPlayer).css("font-weight",b);break;case "explicitDur":d=b.split("s");this.explicitDur=parseInt(d[0]);break;case "baseDeviceRegion":case "deviceClass":case "plan":case "player":case "playerLife":case "reusePlayer":Debugger.warning(Debugger.WARN_NOT_IMPLEMENTED_YET,"property",[a]);break;case "transInBorderColor":case "transInBorderWidth":case "transInDirection":case "transInDur":case "transInEndProgress":case "transInFadeColor":case "transInHorRepeat":case "transInStartProgress":case "transInSubtype":case "transInType":case "transInVertRepeat":case "transBorderColor":case "transOutBorderWidth":case "transOutDirection":case "transOutDur":case "transOutEndProgress":case "transOutFadeColor":case "transOutHorRepeat":case "transOutType":case "transOutStartProgress":case "transOutSubtype":case "transOutVertRepeat":Debugger.warning(Debugger.WARN_NOT_IMPLEMENTED_YET,
"property",[a]);break;case "service.currentFocus":case "default.focusBorderColor":case "default.selBorderColor":case "default.focusBorderWidth":case "default.focusBorderTransparency":this.checkType(["application"])&&this.presentation.systemSettings.setPropertyValue(a,b)}void 0!=c&&(this.player.setProperty?this.player.setProperty(a,b):Debugger.error(Debugger.ERR_MEDIAPLAYER_METHOD_NOTFOUND,this.playerName,["setProperty",a,b]));$(this.htmlPlayer).trigger("attribution.onEndAttribution",[a])};Parser.prototype.parseArea=function(a,b,c){values=["(n\u00famero inteiro)s"];patt=/^\d+s$/;null!=a.begin&&!patt.test(a.begin)&&Debugger.error(Debugger.ERR_INVALID_ATTR_VALUE,b,["begin",a.begin,values]);null!=a.end&&!patt.test(a.end)&&Debugger.error(Debugger.ERR_INVALID_ATTR_VALUE,b,["end",a.end,values]);"application/x-ginga-time"==c.type&&null==a.begin&&null==a.end&&Debugger.error(Debugger.ERR_MISSING_ATTR,b,["begin","end"]);values=["(n\u00famero inteiro)"];patt=/^\d+$/;null!=a.first&&!patt.test(a.first)&&
...
if(null!=a.type)if(a.type=a.type.toLowerCase(),-1==jQuery.inArray(a.type,values))Debugger.error(ERR_INVALID_ATTR_VALUE,b,["type",a.type,values]);else if(null!=a.src){var c=a.src.split(".");a._ext=c[c.length-1].toLowerCase();c=a._ext;switch(a.type){case "text/html":"htm"!=c&&"html"!=c&&Debugger.error(Debugger.ERR_INCOMPATIBLE_FILE_EXT,b,[c,"text/html",["htm","html"]]);break;case "text/plain":"txt"!=c&&Debugger.error(Debugger.ERR_INCOMPATIBLE_FILE_EXT,b,[c,"text/plain",["txt"]]);break;case "text/css":"css"!=
c&&Debugger.error(Debugger.ERR_INCOMPATIBLE_FILE_EXT,b,[c,"text/css",["css"]]);break;case "text/xml":"xml"!=c&&Debugger.error(Debugger.ERR_INCOMPATIBLE_FILE_EXT,b,[c,"text/xml",["xml"]]);break;case "image/bmp":"bmp"!=c&&Debugger.error(Debugger.ERR_INCOMPATIBLE_FILE_EXT,b,[c,"image/bmp",["bmp"]]);break;case "image/png":"png"!=c&&Debugger.error(Debugger.ERR_INCOMPATIBLE_FILE_EXT,b,[c,"image/png",["png"]]);break;case "image/gif":"gif"!=c&&Debugger.error(Debugger.ERR_INCOMPATIBLE_FILE_EXT,b,[c,"image/gif",
["gif"]]);break;case "image/jpeg":"jpg"!=c&&"jpeg"!=c&&Debugger.error(Debugger.ERR_INCOMPATIBLE_FILE_EXT,b,[c,"image/jpeg",["jpg","jpeg"]]);break;case "audio/basic":"wav"!=c&&Debugger.error(Debugger.ERR_INCOMPATIBLE_FILE_EXT,b,[c,"audio/basic",["wav"]]);break;case "audio/mp3":"mp3"!=c&&Debugger.error(Debugger.ERR_INCOMPATIBLE_FILE_EXT,b,[c,"audio/mp3",["mp3"]]);break;case "audio/mp2":"mp2"!=c&&Debugger.error(Debugger.ERR_INCOMPATIBLE_FILE_EXT,b,[c,"audio/mp2",["mp2"]]);break;case "audio/mpeg":"mpeg"!=
c&&"mpg"!=c&&Debugger.error(Debugger.ERR_INCOMPATIBLE_FILE_EXT,b,[c,"audio/mpeg",["mpeg","mpg"]]);break;case "audio/mpeg4":"mp4"!=c&&"mpg4"!=c&&Debugger.error(Debugger.ERR_INCOMPATIBLE_FILE_EXT,b,[c,"audio/mpeg4",["mp4","mpg4"]]);break;case "video/mpeg":"mpeg"!=c&&"mpg"!=c&&Debugger.error(Debugger.ERR_INCOMPATIBLE_FILE_EXT,b,[c,"video/mpeg",["mpeg","mpg"]]);break;case "application/x-ginga-NCLua":"lua"!=c&&Debugger.error(Debugger.ERR_INCOMPATIBLE_FILE_EXT,b,[c,"application/x-ginga-NCLua",["lua"]]);
break;case "application/x-ginga-NCLet":"class"!=c&&"jar"!=c&&Debugger.error(Debugger.ERR_INCOMPATIBLE_FILE_EXT,b,[c,"application/x-ginga-NCLet",["class","jar"]])}}};Parser.prototype.parseMetadata=function(){};Parser.prototype.parseMeta=function(){};Parser.prototype.parseNCL=function(a,b){values=["http://www.ncl.org.br/NCL3.0/EDTVProfile","http://www.ncl.org.br/NCL3.0/BDTVProfile","http://www.ncl.org.br/NCL3.0/CausalConnectorProfile"];null!=a.xmlns&&-1==jQuery.inArray(a.xmlns,values)&&Debugger.error(Debugger.ERR_INVALID_ATTR_VALUE,b,["xmlns",a.xmlns,values])};Parser.prototype.parsePort=function(){};Parser.prototype.parseProperty=function(a){values="system.language,system.caption,system.subtitle,system.returnBitRate(i),system.screenSize,system.screenGraphicSize,system.audioType,system.screenSize(i),system.screenGraphicSize(i),system.audioType(i),system.devNumber(i),system.classType(i),system.info(i),system.classNumber,system.CPU,system.memory,system.operatingSystem,system.javaConfiguration,system.javaProfile,system.luaVersion,user.age,user.location,user.genre,default.focusBorderColor,default.selBorderColor,default.focusBorderWidth,default.focusBorderTransparency,service.currentFocus,service.currentKeyMaster,si.numberOfServices,si.numberOfPartialServices,si.channelNumber,channel.keyCapture,channel.virtualKeyBoard,channel.keyboardBounds".split(",");
...
jQuery.inArray(a.qualifier,values)&&Debugger.error(Debugger.ERR_INVALID_ATTR_VALUE,b,["qualifier",a.qualifier,values])};Parser.prototype.parseSwitch=function(){};Parser.prototype.parseSwitchPort=function(){};Parser.prototype.parseTransitionBase=function(){};Parser.prototype.parseTransition=function(a,b){values=["barWipe","irisWipe","clockWipe","snakeWipe","fade"];null!=a.type&&-1==jQuery.inArray(a.type,values)&&Debugger.error(Debugger.ERR_INVALID_ATTR_VALUE,b,["type",a.type,values]);values=["(n\u00famero inteiro positivo)s"];patt=/^\d+s$/;null!=a.dur&&!patt.test(a.dur)&&Debugger.error(Debugger.ERR_INVALID_ATTR_VALUE,b,["dur",a.dur,values]);values=["(n\u00famero real entre 0 e 1)"];patt=/^(0*\.\d+|1\.0)$/;null!=a.startProgress&&!patt.test(a.startProgress)&&
...
null!=a.fadeColor&&-1==jQuery.inArray(a.fadeColor,values)&&Debugger.error(Debugger.ERR_INVALID_ATTR_VALUE,b,["fadeColor",a.fadeColor,values]);values=["(n\u00famero inteiro n\u00e3o negativo)"];patt=/^\d+$/;null!=a.horRepeat&&-1==patt.test(a.horRepeat,values)&&Debugger.error(Debugger.ERR_INVALID_ATTR_VALUE,b,["horRepeat",a.horRepeat,values]);values=["(n\u00famero inteiro n\u00e3o negativo)"];patt=/^\d+$/;null!=a.vertRepeat&&-1==patt.test(a.vertRepeat,values)&&Debugger.error(Debugger.ERR_INVALID_ATTR_VALUE,
b,["vertRepeat",a.vertRepeat,values]);values=["(n\u00famero inteiro n\u00e3o negativo)"];patt=/^\d+$/;null!=a.borderWidth&&-1==patt.test(a.borderWidth,values)&&Debugger.error(Debugger.ERR_INVALID_ATTR_VALUE,b,["borderWidth",a.borderWidth,values]);values="white,black,silver,gray,red,maroon,fuchsia,purple,lime,green,yellow,olive,blue,navy,aqua,teal,blend".split(",");null!=a.borderColor&&-1==jQuery.inArray(a.borderColor,values)&&Debugger.error(Debugger.ERR_INVALID_ATTR_VALUE,b,["borderColor",a.borderColor,
