...
a+"] "+this.MESSAGES[a]+"\n"+b+": "+c.join(","));this.abort=!0},warning:function(a,b,c){console.warn("["+a+"] "+this.MESSAGES[a]+"\n"+b+": "+c.join(","))}};function RemoteControl(a,b,c){this.player=a;this.divId=b;this.allAreas="powerEject numbers volumeChannel interactive colorful multimedia".split(" ");if(c)for(index in this.areas={},c)area=c[index],0<=$.inArray(area,this.allAreas)?this.areas[area]=!0:console.error("RemoteControl: There is no area called '"+area+"'.");else for(index in this.areas={},this.allAreas)this.areas[this.allAreas[index]]=!0;this.createDivs();this.createSetAreas();this.bindButtonFunctions()}
RemoteControl.prototype.bindButtonFunctions=function(){var a="STart Stop Pause Eject Power Key_1 Key_2 Key_3 Key_4 Key_5 Key_6 Key_7 Key_8 Key_9 Key_Hash Key_0 Key_Star Volume_Up Channel_Up Volume_Down Channel_Down Menu Mute Help Info Guide Exit Back Enter Cursor_Up Cursor_Down Cursor_Left Cursor_Right Red Green Yellow Blue Rewind Play Forward Pause Record Stop".split(" ");for(button in a)eval("$('#Button' + imgButtons[button]).click($.proxy(function(){this.functionButton('"+a[button].toUpperCase()+
"');},this));")};
RemoteControl.prototype.createDivs=function(){document.getElementById(this.divId).innerHTML="<div id='areaSpace1'>\t\t</div>\t\t<div id='areaPowerEject'>\t\t<div \tid='ButtonPower'>\t\t</div>\t\t<div \tid='ButtonEject'>\t\t</div>\t\t</div>\t\t<div id='areaSpace2'>\t\t</div>\t\t<div id='areaNumbers'>\t\t<div \tid='ButtonKey_1'>\t\t</div>\t\t<div \tid='ButtonKey_2'>\t\t</div>\t\t<div \tid='ButtonKey_3'>\t\t</div>\t\t<div \tid='ButtonKey_4'>\t\t</div>\t\t<div \tid='ButtonKey_5'>\t\t</div>\t\t<div \tid='ButtonKey_6'>\t\t</div>\t\t<div \tid='ButtonKey_7'>\t\t</div>\t\t<div \tid='ButtonKey_8'>\t\t</div>\t\t<div \tid='ButtonKey_9'>\t\t</div>\t\t<div \tid='ButtonKey_Hash'>\t\t</div>\t\t<div \tid='ButtonKey_0'>\t\t</div>\t\t<div \tid='ButtonKey_Star'>\t\t</div>\t\t</div>\t\t<div id='areaSpace3'>\t\t</div>\t\t<div id='areaVolumeChannel'>\t\t<div \tid='ButtonVolume_Up'>\t\t</div>\t\t<div \tid='ButtonVolume_Down'>\t\t</div>\t\t<div \tid='ButtonChannel_Up'>\t\t</div>\t\t<div \tid='ButtonChannel_Down'>\t\t</div>\t\t<div \tid='ButtonMenu'>\t\t</div>\t\t<div \tid='ButtonMute'>\t\t</div>\t\t<div \tid='ButtonHelp'>\t\t</div>\t\t</div>\t\t<div id='areaSpace4'>\t\t</div>\t\t<div id='areaInteractive'>\t\t<div \tid='ButtonCursor_Up'>\t\t</div>\t\t<div \tid='ButtonCursor_Down'>\t\t</div>\t\t<div \tid='ButtonCursor_Left'>\t\t</div>\t\t<div \tid='ButtonCursor_Right'>\t\t</div>\t\t<div \tid='ButtonEnter'>\t\t</div>\t\t<div \tid='ButtonInfo'>\t\t</div>\t\t<div \tid='ButtonGuide'>\t\t</div>\t\t<div \tid='ButtonBack'>\t\t</div>\t\t<div \tid='ButtonExit'>\t\t</div>\t\t</div>\t\t<div id='areaSpace5'>\t\t</div>\t\t<div id='areaColorful'>\t\t<div \tid='ButtonRed'>\t\t</div>\t\t<div \tid='ButtonGreen'>\t\t</div>\t\t<div \tid='ButtonYellow'>\t\t</div>\t\t<div \tid='ButtonBlue'>\t\t</div>\t\t</div>\t\t<div id='areaSpace6'>\t\t</div>\t\t<div id='areaMultimedia'>\t\t<div \tid='ButtonRewind'>\t\t</div>\t\t<div \tid='ButtonPlay'>\t\t</div>\t\t<div \tid='ButtonForward'>\t\t</div>\t\t<div \tid='ButtonRecord'>\t\t</div>\t\t<div \tid='ButtonPause'>\t\t</div>\t\t<div \tid='ButtonStop'>\t\t</div>\t\t</div>\t\t<div id='areaSpace7'>\t\t</div>\t\t<div id='areaLogo'>\t\t<div/>\t\t</div>\t\t<div id='areaSpace8'>\t\t</div>";$("#areaSpace1").hide();
$("#areaPowerEject").hide();$("#areaSpace2").hide();$("#areaNumbers").hide();$("#areaSpace3").hide();$("#areaVolumeChannel").hide();$("#areaSpace4").hide();$("#areaInteractive").hide();$("#areaSpace5").hide();$("#areaColorful").hide();$("#areaSpace6").hide();$("#areaMultimedia").hide();$("#areaSpace7").hide();$("#areaLogo").hide();$("#areaSpace8").hide()};
RemoteControl.prototype.createSetAreas=function(){for(index in this.allAreas){var a=this.allAreas[index],b=a.charAt(0).toUpperCase()+a.slice(1);eval("RemoteControl.prototype['setArea"+b+"'] = function(value){\nthis.areas['"+a+"'] = value;\nif (value) {\n$('#areaSpace"+(index+1)+"').show();\n$('#area"+b+"').show();\n} else {\n$('#areaSpace"+(index+1)+"').hide();\n$('#area"+b+"').hide();\n}\nif((this.areas.powerEject)||(this.areas.numbers)||(this.areas.volumeChannel)\n||(this.areas.interactive)||(this.areas.colorful)||(this.areas.multimedia)){\n$('#areaSpace7').show();\n$('#areaLogo').show();\n$('#areaSpace8').show();\n}\nelse{\n$('#areaSpace7').hide();\n$('#areaLogo').hide();\n$('#areaSpace8').hide();\n}\n}");
if(this.areas[a])this["setArea"+b](!0)}};RemoteControl.prototype.functionButton=function(a){switch(a){case "PLAY":this.isPause?this.player.resume():this.player.start();break;case "STOP":this.player.stop();break;case "PAUSE":this.player.pause();this.isPause=!0;break;default:this.player.keyPress(a)}};function Timer(a,b,c){c&&(this.manager=c);this.callback=b;this.timeLeft=a;this.id=this.startTime=null}Timer.prototype.timeout=function(){this.manager&&this.manager.remove(this);this.callback()};Timer.prototype.resume=function(){this.startTime=new Date;this.id=setTimeout($.proxy(function(){this.timeout()},this),this.timeLeft)};Timer.prototype.pause=function(){clearTimeout(this.id);this.timeLeft-=new Date-this.startTime};Timer.prototype.stop=function(){clearTimeout(this.id)};
...
Parser.prototype.importNcl=function(a){if(a)for(var b in a.parsers)this.parsers[[a.alias,"#",b].join("")]=a.parsers[b];a=this.uniqueTable.aliasList.splice(0,1);if(0<a.length)a[0].parser.load(this.path+a[0].url,$.proxy(this.importNcl,this));else{var a=new Date,c;this.referenceMap.createReferences();c=this.importBaseList?this.importBaseList.length:0;for(b=0;b<c;b++){var d=this.importBaseList[b],e=d.obj;if("regionBase"===e.__parent._type&&e.baseId){var f;if((f=d.parser.referenceMap.map[e.baseId])&&f.target)f=
f.target.obj,e.baseId=f,f._alias=e.alias,f.region&&(e.region?(e.region.region||(e.region.region=[]),$.merge(e.region.region,f.region)):this.ncl.head.regionBase.push(f));else{Logger.error(Logger.ERR_INVALID_ID_REFERENCE,[e.alias,"#",e.baseId].join(""),["importBase"]);return}}else if(e.region){var g,k;k=d.parser.ncl.head.regionBase;g=k.length;e.region.region||(e.region.region=[]);for(d=0;d<g;d++)$.merge(e.region.region,k[d].region)}else d.parser.ncl.head.regionBase&&$.merge(this.ncl.head.regionBase,
d.parser.ncl.head.regionBase)}a=new Date-a;this.info.parseTime+=a;this.loading=!1;this.__callback&&this.__callback(this)}};
...
b[d],l=a.xconnector,f={},g={},n=0,r="par",o=l.simpleCondition,s={},t={},m=[];if(l.connectorParam)for(d in l.connectorParam)s["$"+l.connectorParam[d].name]="";if(l.compoundCondition)for(d in o=l.compoundCondition[0].simpleCondition,1<o.length&&(n=Listener.listenerType[l.compoundCondition[0].operator.toUpperCase()]),l.compoundCondition[0].assessmentStatement){var j=l.compoundCondition[0].assessmentStatement[d];for(k in j.attributeAssessment)h=j.attributeAssessment[k],"attribution"==h.eventType&&(!h.attributeType||
"nodeProperty"==h.attributeType?t[h.role]={bindComponent:"",bindInterface:"",operator:j.comparator,value:j.valueAssessment.value,variable:ContextPlayer.isVariable(j.valueAssessment.value)}:console.warn("Eventos de tipos diferentes de attribution nao foram implementados para elementos do tipo AttributeAssessment"))}for(k in t)m.push(t[k]);for(d in o){var j=o[d],h=!1,e="",q=!1;"onSelection"===j.role&&j.key&&(ContextPlayer.isVariable(j.key)&&(h=!0),e=j.key,q=!0);g[j.role]={bindComponent:"",bindInterface:null,
eventType:this.eventType[j.role],flag:!1,keyUseVariable:h,keyDefaultValue:e,useKey:q}}o=l.simpleAction;l.compoundAction&&(r=l.compoundAction[0].operator?l.compoundAction[0].operator.toLowerCase():"seq",o=l.compoundAction[0].simpleAction);for(d in o)j=o[d],"set"==j.role?(l=!1,h="",j.value&&(ContextPlayer.isVariable(j.value)&&(l=!0),h=j.value),f[j.role]={binds:[],qualifier:o[d].qualifier,actionUseVariable:l,actionDefaultValue:h,pendingAcks:0}):f[j.role]={binds:[],qualifier:o[d].qualifier};l=[this];
r=new Listener(n,r,f,g,m,this.presentation,l);if(a.linkParam)for(d in a.linkParam)currentLinkParam=a.linkParam[d],s["$"+currentLinkParam.name]=currentLinkParam.value;for(d in a.bind)if(m=a.bind[d],q=m.component.id,n="#"+this.presentation.getDivId(q),o=m["interface"],f[m.role])h=null,j=f[m.role],"set"==m.role&&(j.actionUseVariable?(p=ContextPlayer.createLocalParamMap(m.bindParam),h=p[j.actionDefaultValue]?p[j.actionDefaultValue]:s[j.actionDefaultValue]):h=j.actionDefaultValue),this.context[q]&&o&&
l.push(this.context[q]),j.binds.push({bindComponent:n,bindInterface:o,value:h});else if(g[m.role]){e=g[m.role];e.bindComponent=n;e.bindInterface=o;var j=n,h=this.eventType[m.role],n=m.role,h=[h,n].join("."),q=[q,h].join("."),u=h+".triggerArray";if(e.useKey){var p=ContextPlayer.createLocalParamMap(m.bindParam);e.keyDefaultValue=p[e.keyDefaultValue]||s[e.keyDefaultValue];p=e.keyDefaultValue;$.isNumeric(p)&&(p="KEY_"+p);p in this.presentation.keys&&(e.keyDefaultValue=this.presentation.keys[p]);p="undefined";
e=j;if("context"==m.component._type&&o){for(d in m.component.port)if(e=m.component.port[d],portId=m.component.port[d].id,portId==o){p=e;break}e="#"+this.presentation.getDivId(p.component.id)}this.presentation.keyEvents[e]=!1}c[q]||(c[q]=!0,$(j).data(u)||$(j).data(u,[]),$(j).data(h)||$(j).data(h,[]),$(j).on(h,{componentDivId:j,bindName:h,eventName:n,triggerArrayName:u},function(a,b,c){var d=$(a.data.componentDivId).data(a.data.bindName),e;for(e in d){var f=d[e],g=f.flagMap[a.data.eventName];b==g.bindInterface&&
(a.type=="selection"&&g.useKey?g.useKey&&a.which&&g.keyDefaultValue==a.which&&f.notifyEvent(a.data.eventName):f.notifyEvent(a.data.eventName))}ContextPlayer.executeTriggerArray($(a.data.componentDivId).data(a.data.triggerArrayName));c&&c()}));r.triggerBuffer=$(j).data(u);$(j).data(h).push(r)}else currentAssessment=t[m.role],currentAssessment.bindComponent=n,currentAssessment.bindInterface=o,currentAssessment.variable&&(p=ContextPlayer.createLocalParamMap(m.bindParam),currentAssessment.value=p[currentAssessment.value]?
...
FlowPlayer.prototype.start=function(){this.flowPlayer.play();console.log(this.flowPlayer)};FlowPlayer.prototype.stop=function(){this.flowPlayer.stop()};FlowPlayer.prototype.pause=function(){this.flowPlayer.pause()};FlowPlayer.prototype.resume=function(){this.flowPlayer.resume()};FlowPlayer.prototype.abort=function(){this.stop()};FlowPlayer.prototype.seek=function(a){this.flowPlayer.seek(a);this.flowPlayer.pause()};FlowPlayer.prototype.seekAndPlay=function(a){this.flowPlayer.seek(a);this.flowPlayer.resume()};function GingaSettingsPlayer(a){console.log("creating GignaSettingsPlayer");this.p=a;this.htmlPlayer="#"+a.id;this.flowPlayer=void 0;a.createElement("<div class='player' id='"+a.id+"'></div>");a.onChangeProperty={};a.onChangeProperty.defaultAction=Player.propertyAction.OVERRIDE;a.onChangeProperty.propertyMap={}}
GingaSettingsPlayer.prototype.setProperty=function(a,b){switch(a){case "service.currentFocus":case "default.focusBorderColor":case "default.selBorderColor":case "default.focusBorderWidth":case "default.focusBorderTransparency":this.p.systemSettings.setPropertyValue(a,b)}$(this.htmlPlayer).trigger("attribution.onEndAttribution",[a])};function Html5Player(a){this.p=a;this.popcornPlayer=void 0;this.htmlPlayer="#"+a.id;this.loadTries=1;this.durationBind=this.duration=void 0;this.durationBinded=!1;this.durationMap={};this.endCallbacks=[];a.onChangeProperty.propertyMap={soundLevel:Player.propertyAction.OVERLOAD,fit:Player.propertyAction.OVERLOAD};switch(a.source.type.split("/")[0]){case "video":a.createElement("<video class='player' id='"+a.id+"'></video>");document.getElementById(this.p.id).addEventListener("error",$.proxy(this.mediaNotFound,
...
b:(e=a,Logger.warning(Logger.WARN_INVALID_AREA,"area",["endText","endPosition"])));e&&(this.p.checkType(["text/plain"])?$(this.htmlPlayer).append(e.replace(/\n/g,"<br/>")):$(this.htmlPlayer).append(e))};function LuaPlayer(a){console.log("constructor lua: "+a.id);this.p=a;this.htmlPlayer="#"+a.id;this.luajscode=void 0;this.persitent=new libPersistent(!1);this.canvas_objects=[];this.events=new libEvents(this);this.broker=new libBroker(this);this.id=0;this.arrayUsers=[];this.isHandlingEvent=!1;a.createElement("<div class='player' id='"+a.id+"'></div>");this.loaded=!1;this.p.onChangeProperty={};this.p.onChangeProperty.defaultAction=Player.propertyAction.OVERRIDE;this.p.onChangeProperty.propertyMap={};
this.p.onChangeProperty.propertyMap.width=Player.propertyAction.IGNORE;this.p.onChangeProperty.propertyMap.height=Player.propertyAction.IGNORE;this.p.onChangeProperty.propertyMap.left=Player.propertyAction.IGNORE;this.p.onChangeProperty.propertyMap.top=Player.propertyAction.IGNORE;this.pathlua="";var b=document.createElement("table");b.setAttribute("id","myTable");b.setAttribute("class","panel");var c=document.createElement("tbody");b.appendChild(c);$("#content").append(b);a.enableKeyEvents();console.log(a.id)}
LuaPlayer.prototype.unload=function(){$(this.htmlPlayer).empty()};LuaPlayer.prototype.load=function(a){var b=a.split("/");this.pathLua=b[0]+"/"+b[1]+"/";console.log(this.pathLua);$.ajax({type:"GET",url:a,dataType:"text",async:!1,success:$.proxy(function(a){this.luajscode=lua_load("canvas = libCanvas.init();\n"+a)},this),error:function(){console.log("error to load file")}});this.bindlibs()};LuaPlayer.prototype.exec=function(a){console.log("exec lua: "+a)};
...
!1)};
MediaPlayer.prototype.create=function(a){a.descriptor&&(this.transIn=a.descriptor.transIn,this.transOut=a.descriptor.transOut,this.explicitDur=a.descriptor.explicitDur);if(a.type)this.type=a.type;else if(a.src){var b=a.src.split(".");this.type=this.mediaTypes[b[b.length-1]]}else this.type="dummy";this.htmlPlayer="#"+this.divId;this.htmlPlayerBkg="#"+this.presentation.getDivId(a.id,"bkg");this.region="application/x-ginga-settings"===this.type?"#"+this.presentation.settingsDiv:"#"+this.presentation.playerDiv;!this.presentation.settingsNode&&
"application/x-ginga-settings"==this.type&&(this.presentation.settingsNode=this);if(!(a.refer&&"new"!=a.instance)){$(this.region).append("<div class='playerBkg' id='"+this.presentation.getDivId(a.id,"bkg")+"'></div>");this.playerSettings={source:{type:this.type,url:this.presentation.path+a.src},onChangeProperty:{defaultAction:Player.propertyAction.IGNORE,propertyMap:{}},id:this.divId,parentId:this.presentation.getDivId(a.id,"bkg"),createElement:$.proxy(this.createElement,this),checkType:$.proxy(this.checkType,
this),getProperty:$.proxy(this.getProperty,this),setProperty:$.proxy(this.setProperty,this),postEvent:this.presentation.postEvent,systemSettings:this.presentation.systemSettings,enableKeyEvents:$.proxy(this.enableKeyEvents,this),area:a.area};var c,b=this.presentation.mediaPlayers,d=void 0;if(a.descriptor&&a.descriptor.player)for(f in d=a.descriptor.player,a.descriptor.descriptorParam){var e=a.descriptor.descriptorParam[f];if("player"==e.name){d=e.value;break}}for(f in a.property)if(e=a.property[f],
"player"==e.name){d=e.value;break}d&&("function"==eval("typeof "+d)&&"object"==eval("typeof "+d+".prototype")?c=eval(d):(Logger.error(Logger.WARN_MEDIAPLAYER_NOT_FOUND,"Descriptor Player",[d]),this.player={}));!c&&b[this.type]&&(c=b[this.type][a._ext]||b[this.type].defaultPlayer);if(c){this.player=new c(this.playerSettings);this.playerName=c.name;c="load unload exec start stop pause resume abort seek seekAndPlay setProperty getDuration keyEventHandler".split(" ");for(var f in c)this.player[c[f]]||
(this.player[c[f]]=$.proxy(function(){Logger.warning(Logger.ERR_MEDIAPLAYER_METHOD_NOTFOUND,this.playerName,[this.fname])},{playerName:this.playerName,fname:c[f]}))}else Logger.error(Logger.ERR_MEDIAPLAYER_NOPLAYER,this.type,[]),this.player={};$(this.htmlPlayerBkg).css("display","none");this.load(a.src);this.data=$(this.htmlPlayer).data();this.player.exec&&this.player.exec("end",$.proxy(function(){if(this.playingArea){$(this.htmlPlayer).trigger("presentation.onEnd");this.playingArea=void 0}else this.stop()},
this));$(this.htmlPlayer).data("property",[]);if(a.descriptor)for(f in a.descriptor.explicitDur&&this.setProperty("explicitDur",a.descriptor.explicitDur),a.descriptor.region&&(this.setProperty("zIndex",a.descriptor.region.zIndex),this.setProperty("width",a.descriptor.region.width),this.setProperty("height",a.descriptor.region.height),this.setProperty("bottom",a.descriptor.region.bottom),this.setProperty("top",a.descriptor.region.top),this.setProperty("right",a.descriptor.region.right),this.setProperty("left",
a.descriptor.region.left),this.setProperty("title",a.descriptor.region.title)),a.descriptor.descriptorParam)this.setProperty(a.descriptor.descriptorParam[f].name,a.descriptor.descriptorParam[f].value);c=[];for(f in a.property)if(a.property[f].value)switch(a.property[f].name){case "bounds":case "top":case "left":case "bottom":case "right":case "height":case "width":c.push({name:a.property[f].name,value:a.property[f].value});break;default:this.setProperty(a.property[f].name,a.property[f].value)}if(0<
c.length){a={left:0,top:0,width:parseInt($("#"+this.presentation.playerDiv).css("width").split("px")[0]),height:parseInt($("#"+this.presentation.playerDiv).css("height").split("px")[0])};b={left:null,right:null,top:null,bottom:null,width:null,height:null};this.node.descriptor&&this.node.descriptor.region&&(a.left=this.node.descriptor.region._parent.left?parseInt(this.node.descriptor.region._parent.left.split("px")[0]):0,a.top=this.node.descriptor.region._parent.top?parseInt(this.node.descriptor.region._parent.top.split("px")[0]):
0,a.width=this.node.descriptor.region._parent.width?parseInt(this.node.descriptor.region._parent.width.split("px")[0]):parseInt($("#"+this.presentation.playerDiv).css("width").split("px")[0]),a.height=this.node.descriptor.region._parent.height?parseInt(this.node.descriptor.region._parent.height.split("px")[0]):parseInt($("#"+this.presentation.playerDiv).css("height").split("px")[0]),b.left=(this.node.descriptor.region.left.split("px")[0]-a.left).toString(),b.top=(this.node.descriptor.region.top.split("px")[0]-
a.top).toString(),b.width=this.node.descriptor.region.width,b.height=this.node.descriptor.region.height);for(f in c){var g=c[f].name,d=c[f].value;switch(g){case "bounds":d=d.split(",");b.left=d[0];b.top=d[1];b.width=d[2];b.height=d[3];break;case "top":case "left":case "bottom":case "right":case "height":case "width":b[g]=d}}WebNclPlayer.prototype.fixRegionBounds(b,a);for(g in b)(d=b[g])&&null!=d&&this.setProperty(g,d)}this.player.exec("end",$.proxy(function(){if(this.playingArea){$(this.htmlPlayer).trigger("presentation.onEnd");
