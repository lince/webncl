...
c.type)?"refer"==c.attr?"media"==c.obj._type&&(c.obj.descriptor=this.map[a].target.obj.descriptor,c.obj.src=this.map[a].target.obj.src,c.obj.type=this.map[a].target.obj.type,"new"!=c.obj.instance&&(this.instReuse[c.obj.id]=a)):c.obj[c.attr]=this.map[a].target.obj:Logger.error(Logger.ERR_INVALID_ID_REFERENCE,c.type,[c.attr,c.obj[c.attr],c.type])}};Parser.isNotArray="ncl head body importedDocumentBase ruleBase transitionBase descriptorBase connectorBase defaultDescriptor valueAssessment defaultComponent".split(" ");
...
this);a.str.attrClip=$.proxy(function(a,c,d,e,f){this.variable.canvas_objects[a.str.id].attrClip(c,d,e,f)},this);return[a]},lua_libs.libCanvas);persist=this.persitent;lua_libs.persistent={set:function(a,b,c){persist.storeField(a,b,c)},get:function(a){return[persist.recoverField(a)]}};events=this.events;lua_libs.event={post:function(a){events.post(a)},register:function(a){events.register(a)},unregister:function(a){events.unregister(a)},timer:function(a,b){events.timer(a,b)},uptime:function(){return[events.uptime()]}}};
