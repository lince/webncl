var Logger={WARN_INVALID_ATTR:100,WARN_INVALID_TAG:101,WARN_INVALID_HEAD_STRUCTURE:102,WARN_INVALID_REGION_DIMENSIONS:103,WARN_DUPLICATED_ZINDEX:104,WARN_INVALID_AREA:105,WARN_NOT_IMPLEMENTED_YET:106,WARN_MEDIA_NOT_FOUND:107,WARN_MEDIAPLAYER_NOT_FOUND:108,WARN_REGIONATTR_IMPORTBASE_NOTINTO_RB:109,ERR_MISSING_ATTR:201,ERR_MISSING_ATTR_ONEOF:202,ERR_MISSING_ATTR_DEP:203,ERR_TOO_MANY_ATTRS:204,ERR_MISSING_TAG:205,ERR_MISSING_TAG_ONEOF:206,ERR_TOO_MANY_TAGS:207,ERR_TOO_MANY_TAGS_ONEOF:208,ERR_INVALID_ATTR_VALUE:209,
ERR_INVALID_ID_REFERENCE:210,ERR_DUPLICATED_ID:211,ERR_INCOMPATIBLE_FILE_EXT:212,ERR_INVALID_URI:213,ERR_DUPLICATED_ATTR:214,ERR_DUPLICATED_ALIAS:215,ERR_INVALID_CONTEXT_REFERENCE:216,ERR_MEDIAPLAYER_METHOD_NOTFOUND:217,ERR_MEDIAPLAYER_NOPLAYER:218,ERR_PARSER_LOADINGERROR:219,ERR_INVALID_ALIAS:220,MESSAGES:{100:"Atributo inv\u00e1lido",101:"Tag inv\u00e1lida",102:"Estrutura do cabe\u00e7alho inv\u00e1lida",103:"Dimens\u00f5es de regi\u00e3o inv\u00e1lidas",104:"zIndex duplicado",105:"Areaa invalida",
106:"Recurso n\u00e3o implementado ainda",107:"M\u00eddia n\u00e3o encontrada",108:"Media Player n\u00e3o encontrado",109:"Atributo 'region' especificado em um importBase que n\u00e3o descendente de um regionBase",201:"Atributo obrigat\u00f3rio faltando",202:"Atributo obrigat\u00f3rio faltando (um desses)",203:"Atributo dependente faltando",204:"Excesso de atributos repetidos",205:"Tag obrigat\u00f3ria faltando",206:"Tag obrigat\u00f3ria faltando (uma dessas)",207:"Excesso de tags repetidas",208:"Excesso de tags (apenas uma permitida)",
209:"Valor de atributo inv\u00e1lido",210:"Refer\u00eancia a ID inv\u00e1lido",211:"ID duplicado",212:"Extens\u00e3o de arquivo incompat\u00edvel com o MIMETYPE",213:"URI inv\u00e1lida",214:"Atributo duplicado",215:"Alias duplicado",216:"Objeto referenciado em outro contexto",217:"M\u00e9todo n\u00e3o encontrado no media player",218:"Nenhum player foi definido para este mime type/extens\u00e3o",219:"Erro carregando arquivo",220:"Alias inv\u00e1lido!"},abort:!1,error:function(a,b,c){console.error("["+
a+"] "+this.MESSAGES[a]+"\n"+b+": "+c.join(","));this.abort=!0},warning:function(a,b,c){console.warn("["+a+"] "+this.MESSAGES[a]+"\n"+b+": "+c.join(","))}};function RemoteControl(a,b,c,d,e,f,g,k,h,l){this.player=a;this.divId=b;this.p_areaPowerEject=e;this.p_areaNumbers=f;this.p_areaVolumeChannel=g;this.p_areaInteractive=k;this.p_areaColorful=h;this.p_areaMultimedia=l;this.top=c;this.left=d;style="\t/*==================== Divs das \u00e1reas do Controle =====================*/\t\t\t\t/*--- \u00c1rea Geral do Controle ---*/\t\t#areaRemoteControl{\t\tposition:absolute;\t\twidth:134.74px;\t\theight:600px;\t\ttop:"+this.top+"px;\t\tleft:"+this.left+"px;\t\t}\t\t\t\t/*--- \u00c1rea do Espa\u00e7amento 1 ---*/\t\t#areaSpace1{\t\tposition:relative;\t\tbackground-image:url(images/control/space.png);\t\theight:1%;\t\twidth:100%;\t\tbackground-size:134.74px 6px;\t\t}\t\t\t\t/*--- \u00c1rea do Espa\u00e7amento 2 ---*/\t\t#areaSpace2{\t\tposition:relative;\t\tbackground-image:url(images/control/space.png);\t\theight:1%;\t\twidth:100%;\t\tbackground-size:134.74px 6px;\t\t}\t\t\t\t/*--- \u00c1rea do Espa\u00e7amento 3 ---*/\t\t#areaSpace3{\t\tposition:relative;\t\tbackground-image:url(images/control/space.png);\t\theight:1%;\t\twidth:100%;\t\tbackground-size:134.74px 6px;\t\t}\t\t\t\t/*--- \u00c1rea do Espa\u00e7amento 4 ---*/\t\t#areaSpace4{\t\tposition:relative;\t\tbackground-image:url(images/control/space.png);\t\theight:1%;\t\twidth:100%;\t\tbackground-size:134.74px 6px;\t\t}\t\t\t\t/*--- \u00c1rea do Espa\u00e7amento 5 ---*/\t\t#areaSpace5{\t\tposition:relative;\t\tbackground-image:url(images/control/space.png);\t\theight:1%;\t\twidth:100%;\t\tbackground-size:134.74px 6px;\t\t}\t\t\t\t/*--- \u00c1rea do Espa\u00e7amento 6 ---*/\t\t#areaSpace6{\t\tposition:relative;\t\tbackground-image:url(images/control/space.png);\t\theight:1%;\t\twidth:100%;\t\tbackground-size:134.74px 6px;\t\t}\t\t\t\t/*--- \u00c1rea do Espa\u00e7amento 7 ---*/\t\t#areaSpace7{\t\tposition:relative;\t\tbackground-image:url(images/control/space.png);\t\theight:1%;\t\twidth:100%;\t\tbackground-size:134.74px 6px;\t\t}\t\t\t\t/*--- \u00c1rea do Espa\u00e7amento 8 ---*/\t\t#areaSpace8{\t\tposition:relative;\t\tbackground-image:url(images/control/space.png);\t\theight:1%;\t\twidth:100%;\t\tbackground-size:134.74px 6px;\t\t}\t\t\t\t/*--- \u00c1rea do Power e Eject ---*/\t\t#areaPowerEject{\t\tposition:relative;\t\theight:6%;\t\twidth:100%;\t\tbackground-image:url(images/control/power_eject.png);\t\tbackground-size:134.74px 36px;\t\t}\t\t\t\t/*--- \u00c1rea dos Alfanum\u00e9ricos ---*/\t\t#areaNumbers{\t\tposition:relative;\t\theight:21%;\t\twidth:100%;\t\tbackground-image:url(images/control/numbers.png);\t\tbackground-size:134.74px 126px;\t\t}\t\t\t\t/*--- \u00c1rea do Volume e do Channel ---*/\t\t#areaVolumeChannel{\t\tposition:relative;\t\theight:20%;\t\twidth:100%;\t\tbackground-image:url(images/control/volume_channel.png);\t\tbackground-size:134.74px 120px;\t\t}\t\t\t\t/*--- \u00c1rea dos Interativos ---*/\t\t#areaInteractive{\t\tposition:relative;\t\theight:21%;\t\twidth:100%;\t\tbackground-image:url(images/control/interactive.png);\t\tbackground-size:134.74px 126px;\t\t}\t\t\t\t/*--- \u00c1rea dos Coloridos ---*/\t\t#areaColorful{\t\tposition:relative;\t\theight:5%;\t\twidth:100%;\t\tbackground-image:url(images/control/colorful.png);\t\tbackground-size:134.74px 30px;\t\t}\t\t\t\t/*--- \u00c1rea Multim\u00eddia ---*/\t\t#areaMultimedia{\t\tposition:relative;\t\theight:14%;\t\twidth:100%;\t\tbackground-image:url(images/control/multimedia.png);\t\tbackground-size:134.74px 84px;\t\t}\t\t\t\t/*--- \u00c1rea do Logo ---*/\t\t#areaLogo{\t\tposition:relative;\t\theight:5%;\t\twidth:100%;\t\tbackground-image:url(images/control/multimedia.png);\t\tbackground-size:134.74px 30px;\t\t}\t\t\t\t\t\t/*======================== Divs dos Bot\u00f5es =========================*/\t\t\t\t/*--- Bot\u00e3o Power ---*/\t\t#ButtonPower{\t\tposition: absolute;\t\twidth: 28px;\t\theight: 27px;\t\ttop: 6.5px;\t\tleft:12.8px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Power.png);\t\tbackground-size:28px 27px;\t\t}\t\t\t\t#ButtonPower:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonPower:active{\t\tbackground-image:url(images/control/Buttons/press/png/Power.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Eject ---*/\t\t#ButtonEject{\t\tposition: absolute;\t\twidth: 20.7px;\t\theight: 19.7px;\t\ttop: 13.4px;\t\tleft:101.7px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Eject.png);\t\tbackground-size:20.7px 19.7px;\t\t}\t\t\t\t#ButtonEject:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonEject:active{\t\tbackground-image:url(images/control/Buttons/press/png/Eject.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Key_1 ---*/\t\t#ButtonKey_1{\t\tposition: absolute;\t\twidth: 30px;\t\theight: 24px;\t\ttop: 4px;\t\tleft:12px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Key_1.png);\t\tbackground-size:30px 24px;\t\t}\t\t\t\t#ButtonKey_1:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonKey_1:active{\t\tbackground-image:url(images/control/Buttons/press/png/Key_1.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Key_2 ---*/\t\t#ButtonKey_2{\t\tposition: absolute;\t\twidth: 30px;\t\theight: 24px;\t\ttop: 4px;\t\tleft:52.5px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Key_2.png);\t\tbackground-size:30px 24px;\t\t}\t\t\t\t#ButtonKey_2:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonKey_2:active{\t\tbackground-image:url(images/control/Buttons/press/png/Key_2.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Key_3 ---*/\t\t#ButtonKey_3{\t\tposition: absolute;\t\twidth: 30px;\t\theight: 24px;\t\ttop: 4.5px;\t\tleft:94px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Key_3.png);\t\tbackground-size:30px 24px;\t\t}\t\t\t\t#ButtonKey_3:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonKey_3:active{\t\tbackground-image:url(images/control/Buttons/press/png/Key_3.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Key_4 ---*/\t\t#ButtonKey_4{\t\tposition: absolute;\t\twidth: 30px;\t\theight: 24px;\t\ttop: 35.5px;\t\tleft:12px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Key_4.png);\t\tbackground-size:30px 24px;\t\t}\t\t\t\t#ButtonKey_4:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonKey_4:active{\t\tbackground-image:url(images/control/Buttons/press/png/Key_4.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Key_5 ---*/\t\t#ButtonKey_5{\t\tposition: absolute;\t\twidth: 30px;\t\theight: 24px;\t\ttop: 35.5px;\t\tleft:52.5px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Key_5.png);\t\tbackground-size:30px 24px;\t\t}\t\t\t\t#ButtonKey_5:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonKey_5:active{\t\tbackground-image:url(images/control/Buttons/press/png/Key_5.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Key_6 ---*/\t\t#ButtonKey_6{\t\tposition: absolute;\t\twidth: 30px;\t\theight: 24px;\t\ttop: 35.5px;\t\tleft:94px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Key_6.png);\t\tbackground-size:30px 24px;\t\t}\t\t\t\t#ButtonKey_6:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonKey_6:active{\t\tbackground-image:url(images/control/Buttons/press/png/Key_6.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Key_7 ---*/\t\t#ButtonKey_7{\t\tposition: absolute;\t\twidth: 30px;\t\theight: 24px;\t\ttop: 66.7px;\t\tleft:12px;\t\tcursor:pointer;;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Key_7.png);\t\tbackground-size:30px 24px;\t\t}\t\t\t\t#ButtonKey_7:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonKey_7:active{\t\tbackground-image:url(images/control/Buttons/press/png/Key_7.png);\t\t}\t\t\t\t\t\t/*--- Bot\u00e3o Key_8 ---*/\t\t#ButtonKey_8{\t\tposition: absolute;\t\twidth: 30px;\t\theight: 24px;\t\ttop: 66.7px;\t\tleft:52.5px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Key_8.png);\t\tbackground-size:30px 24px;\t\t}\t\t\t\t#ButtonKey_8:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonKey_8:active{\t\tbackground-image:url(images/control/Buttons/press/png/Key_8.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Key_9 ---*/\t\t#ButtonKey_9{\t\tposition: absolute;\t\twidth: 30px;\t\theight: 24px;\t\ttop: 66.7px;\t\tleft:94px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Key_9.png);\t\tbackground-size:30px 24px;\t\t}\t\t\t\t#ButtonKey_9:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonKey_9:active{\t\tbackground-image:url(images/control/Buttons/press/png/Key_9.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Key_Hash ---*/\t\t#ButtonKey_Hash{\t\tposition: absolute;\t\twidth: 30px;\t\theight: 24px;\t\ttop: 98px;\t\tleft:12px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Key_Hash.png);\t\tbackground-size:30px 24px;\t\t}\t\t\t\t#ButtonKey_Hash:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonKey_Hash:active{\t\tbackground-image:url(images/control/Buttons/press/png/Key_Hash.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Key_0 ---*/\t\t#ButtonKey_0{\t\tposition: absolute;\t\twidth: 30px;\t\theight: 24px;\t\ttop: 98px;\t\tleft:52.6px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Key_0.png);\t\tbackground-size:30px 24px;\t\t}\t\t\t\t#ButtonKey_0:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonKey_0:active{\t\tbackground-image:url(images/control/Buttons/press/png/Key_0.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Key_Star ---*/\t\t#ButtonKey_Star{\t\tposition: absolute;\t\twidth: 30px;\t\theight: 24px;\t\ttop: 98px;\t\tleft:94px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Key_Star.png);\t\tbackground-size:30px 24px;\t\t}\t\t\t\t#ButtonKey_Star:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonKey_Star:active{\t\tbackground-image:url(images/control/Buttons/press/png/Key_Star.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Volume_Up ---*/\t\t#ButtonVolume_Up{\t\tposition: absolute;\t\twidth: 29px;\t\theight: 27px;\t\ttop: 4.7px;\t\tleft:11px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Volume_Up.png);\t\tbackground-size:29px 27px;\t\t}\t\t\t\t#ButtonVolume_Up:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonVolume_Up:active{\t\tbackground-image:url(images/control/Buttons/press/png/Volume_Up.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Volume_Down ---*/\t\t#ButtonVolume_Down{\t\tposition: absolute;\t\twidth: 29px;\t\theight: 26.5px;\t\ttop: 49px;\t\tleft:11px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Volume_Down.png);\t\tbackground-size:29px 26.5px;\t\t}\t\t\t\t#ButtonVolume_Down:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonVolume_Down:active{\t\tbackground-image:url(images/control/Buttons/press/png/Volume_Down.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Channel_Up ---*/\t\t#ButtonChannel_Up{\t\tposition: absolute;\t\twidth: 29px;\t\theight: 27px;\t\ttop: 5px;\t\tleft:94px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Volume_Up.png);\t\tbackground-size:29px 27px;\t\t}\t\t\t\t#ButtonChannel_Up:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonChannel_Up:active{\t\tbackground-image:url(images/control/Buttons/press/png/Volume_Up.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Channel_Down ---*/\t\t#ButtonChannel_Down{\t\tposition: absolute;\t\twidth: 29px;\t\theight: 27px;\t\ttop: 49px;\t\tleft:95px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Volume_Down.png);\t\tbackground-size:29px 27px;\t\t}\t\t\t\t#ButtonChannel_Down:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonChannel_Down:active{\t\tbackground-image:url(images/control/Buttons/press/png/Volume_Down.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Menu ---*/\t\t#ButtonMenu{\t\tposition: absolute;\t\twidth: 30.9px;\t\theight: 34.7px;\t\ttop: 21px;\t\tleft:51px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Menu.png);\t\tbackground-size:30.9px 34.7px;\t\t}\t\t\t\t#ButtonMenu:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonMenu:active{\t\tbackground-image:url(images/control/Buttons/press/png/Menu.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Mute ---*/\t\t#ButtonMute{\t\tposition: absolute;\t\twidth: 26.4px;\t\theight: 29.5px;\t\ttop: 86px;\t\tleft:12.3px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Mute.png);\t\tbackground-size:26.4px 29.5px;\t\t}\t\t\t\t#ButtonMute:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonMute:active{\t\tbackground-image:url(images/control/Buttons/press/png/Mute.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Help ---*/\t\t#ButtonHelp{\t\tposition: absolute;\t\twidth: 26.9px;\t\theight: 29.9px;\t\ttop: 86.1px;\t\tleft:95.6px;\t\tcursor:pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Help.png);\t\tbackground-size:26.9px 30px\t\t}\t\t\t\t#ButtonHelp:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonHelp:active{\t\tbackground-image:url(images/control/Buttons/press/png/Help.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Info ---*/\t\t#ButtonInfo{\t\tposition: absolute;\t\twidth: 26px;\t\theight: 26px;\t\ttop: 4px;\t\tleft: 12.5px;\t\tcursor: pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Info.png);\t\tbackground-size:26px 26px;\t\t}\t\t\t\t#ButtonInfo:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonInfo:active{\t\tbackground-image:url(images/control/Buttons/press/png/Info.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Exit ---*/\t\t#ButtonExit{\t\tposition: absolute;\t\twidth: 25.7px;\t\theight: 26.1px;\t\ttop: 95px;\t\tleft: 13px;\t\tcursor: pointer;;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Exit.png);\t\tbackground-size:25.7px 26.1px;\t\t}\t\t\t\t#ButtonExit:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonExit:active{\t\tbackground-image:url(images/control/Buttons/press/png/Exit.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Guide ---*/\t\t#ButtonGuide{\t\tposition: absolute;\t\twidth: 25.8px;\t\theight: 26px;\t\ttop: 4px;\t\tleft: 96.3px;\t\tcursor: pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Guide.png);\t\tbackground-size:25.8px 26px;\t\t}\t\t\t\t#ButtonGuide:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonGuide:active{\t\tbackground-image:url(images/control/Buttons/press/png/Guide.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Back ---*/\t\t#ButtonBack{\t\tposition: absolute;\t\twidth: 25.6px;\t\theight: 25.4px;\t\ttop: 96px;\t\tleft: 97px;\t\tcursor: pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Back.png);\t\tbackground-size:25.6px 25.4px;\t\t}\t\t\t\t#ButtonBack:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonBack:active{\t\tbackground-image:url(images/control/Buttons/press/png/Back.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Enter ---*/\t\t#ButtonEnter{\t\tposition: absolute;\t\twidth: 42.5px;\t\theight: 43px;\t\ttop: 42px;\t\tleft: 46px;\t\tcursor: pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Enter.png);\t\tbackground-size:42.5px 43px;\t\t}\t\t\t\t#ButtonEnter:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonEnter:active{\t\tbackground-image:url(images/control/Buttons/press/png/Enter.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Cursor_Up ---*/\t\t#ButtonCursor_Up{\t\tposition: absolute;\t\twidth: 53px;\t\theight: 21px;\t\ttop: 16.5px;\t\tleft: 41.5px;\t\tcursor: pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Cursor_Up.png);\t\tbackground-size:53px 21px;\t\t}\t\t\t\t#ButtonCursor_Up:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonCursor_Up:active{\t\tbackground-image:url(images/control/Buttons/press/png/Cursor_Up.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Cursor_Down ---*/\t\t#ButtonCursor_Down{\t\tposition: absolute;\t\twidth: 52px;\t\theight: 20px;\t\ttop: 90px;\t\tleft: 41px;\t\tcursor: pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Cursor_Down.png);\t\tbackground-size:52px 20px;\t\t}\t\t\t\t#ButtonCursor_Down:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonCursor_Down:active{\t\tbackground-image:url(images/control/Buttons/press/png/Cursor_Down.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Cursor_Left ---*/\t\t#ButtonCursor_Left{\t\tposition: absolute;\t\twidth: 20px;\t\theight: 55px;\t\ttop: 36px;\t\tleft: 21px;\t\tcursor: pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Cursor_Left.png);\t\tbackground-size:20px 55px;\t\t}\t\t\t\t#ButtonCursor_Left:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonCursor_Left:active{\t\tbackground-image:url(images/control/Buttons/press/png/Cursor_Left.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Cursor_Right ---*/\t\t#ButtonCursor_Right{\t\tposition: absolute;\t\twidth: 20px;\t\theight: 54px;\t\ttop: 36px;\t\tleft: 93.5px;\t\tcursor: pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Cursor_Right.png);\t\tbackground-size:20px 54px;\t\t}\t\t\t\t#ButtonCursor_Right:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonCursor_Right:active{\t\tbackground-image:url(images/control/Buttons/press/png/Cursor_Right.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Red ---*/\t\t#ButtonRed{\t\tposition: absolute;\t\twidth: 22px;\t\theight: 21px;\t\ttop: 4.5px;\t\tleft: 14.5px;\t\tcursor: pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Red.png);\t\tbackground-size:22px 21px;\t\t}\t\t\t\t#ButtonRed:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonRed:active{\t\tbackground-image:url(images/control/Buttons/press/png/Red.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Green ---*/\t\t#ButtonGreen{\t\tposition: absolute;\t\twidth: 21px;\t\theight: 21px;\t\ttop: 4px;\t\tleft: 42.5px;\t\tcursor: pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Green.png);\t\tbackground-size:21px 21px;\t\t}\t\t\t\t#ButtonGreen:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonGreen:active{\t\tbackground-image:url(images/control/Buttons/press/png/Green.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Yellow ---*/\t\t#ButtonYellow{\t\tposition: absolute;\t\twidth: 21px;\t\theight: 20px;\t\ttop: 4.5px;\t\tleft: 70.5px;\t\tcursor: pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Yellow.png);\t\tbackground-size:21px 20px;\t\t}\t\t\t\t#ButtonYellow:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonYellow:active{\t\tbackground-image:url(images/control/Buttons/press/png/Yellow.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Blue ---*/\t\t#ButtonBlue{\t\tposition: absolute;\t\twidth: 22px;\t\theight: 21px;\t\ttop: 5px;\t\tleft: 98px;\t\tcursor: pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Blue.png);\t\tbackground-size:22px 21px;\t\t}\t\t\t\t#ButtonBlue:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonBlue:active{\t\tbackground-image:url(images/control/Buttons/press/png/Blue.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Rewind ---*/\t\t#ButtonRewind{\t\tposition: absolute;\t\twidth: 30.2px;\t\theight: 25.5px;\t\ttop: 11px;\t\tleft: 12.6px;\t\tcursor: pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Rewind.png);\t\tbackground-size:30.2px 25.5px;\t\t}\t\t\t\t#ButtonRewind:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonRewind:active{\t\tbackground-image:url(images/control/Buttons/press/png/Rewind.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Play ---*/\t\t#ButtonPlay{\t\tposition: absolute;\t\twidth: 22px;\t\theight: 37.8px;\t\ttop: 5px;\t\tleft: 58.5px;\t\tcursor: pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Play.png);\t\tbackground-size:22px 38px;\t\t}\t\t\t\t#ButtonPlay:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonPlay:active{\t\tbackground-image:url(images/control/Buttons/press/png/Play.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Forward ---*/\t\t#ButtonForward{\t\tposition: absolute;\t\twidth: 31.7px;\t\theight: 26.7px;\t\ttop: 12.1px;\t\tleft: 91.5px;\t\tcursor: pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Forward.png);\t\tbackground-size:31.7px 26.7px;\t\t}\t\t\t\t#ButtonForward:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonForward:active{\t\tbackground-image:url(images/control/Buttons/press/png/Forward.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Record ---*/\t\t#ButtonRecord{\t\tposition: absolute;\t\twidth: 26px;\t\theight: 27px;\t\ttop: 52px;\t\tleft: 16px;\t\tcursor: pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Record.png);\t\tbackground-size:26px 27px;\t\t}\t\t\t\t#ButtonRecord:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonRecord:active{\t\tbackground-image:url(images/control/Buttons/press/png/Record.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Pause ---*/\t\t#ButtonPause{\t\tposition: absolute;\t\twidth: 15.2px;\t\theight: 24.8px;\t\ttop: 54.5px;\t\tleft: 59.2px;\t\tcursor: pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Pause.png);\t\tbackground-size:15.2px 24.8px;\t\t}\t\t\t\t#ButtonPause:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonPause:active{\t\tbackground-image:url(images/control/Buttons/press/png/Pause.png);\t\t}\t\t\t\t/*--- Bot\u00e3o Stop ---*/\t\t#ButtonStop{\t\tposition: absolute;\t\twidth: 25px;\t\theight: 27.1px;\t\ttop: 52.2px;\t\tleft: 93px;\t\tcursor: pointer;\t\topacity:0;\t\tbackground-image:url(images/control/Buttons/hover/png/Stop.png);\t\tbackground-size:25px 27.1px;\t\t}\t\t\t\t#ButtonStop:hover{\t\topacity:1;\t\t}\t\t\t\t#ButtonStop:active{\t\tbackground-image:url(images/control/Buttons/press/png/Stop.png);\t\t}";
$("<style>").text(style).appendTo("head");document.getElementById(this.divId).innerHTML="<div id='areaSpace1'>\t\t</div>\t\t<div id='areaPowerEject'>\t\t<div \tid='ButtonPower'>\t\t</div>\t\t<div \tid='ButtonEject'>\t\t</div>\t\t</div>\t\t<div id='areaSpace2'>\t\t</div>\t\t<div id='areaNumbers'>\t\t<div \tid='ButtonKey_1'>\t\t</div>\t\t<div \tid='ButtonKey_2'>\t\t</div>\t\t<div \tid='ButtonKey_3'>\t\t</div>\t\t<div \tid='ButtonKey_4'>\t\t</div>\t\t<div \tid='ButtonKey_5'>\t\t</div>\t\t<div \tid='ButtonKey_6'>\t\t</div>\t\t<div \tid='ButtonKey_7'>\t\t</div>\t\t<div \tid='ButtonKey_8'>\t\t</div>\t\t<div \tid='ButtonKey_9'>\t\t</div>\t\t<div \tid='ButtonKey_Hash'>\t\t</div>\t\t<div \tid='ButtonKey_0'>\t\t</div>\t\t<div \tid='ButtonKey_Star'>\t\t</div>\t\t</div>\t\t<div id='areaSpace3'>\t\t</div>\t\t<div id='areaVolumeChannel'>\t\t<div \tid='ButtonVolume_Up'>\t\t</div>\t\t<div \tid='ButtonVolume_Down'>\t\t</div>\t\t<div \tid='ButtonChannel_Up'>\t\t</div>\t\t<div \tid='ButtonChannel_Down'>\t\t</div>\t\t<div \tid='ButtonMenu'>\t\t</div>\t\t<div \tid='ButtonMute'>\t\t</div>\t\t<div \tid='ButtonHelp'>\t\t</div>\t\t</div>\t\t<div id='areaSpace4'>\t\t</div>\t\t<div id='areaInteractive'>\t\t<div \tid='ButtonCursor_Up'>\t\t</div>\t\t<div \tid='ButtonCursor_Down'>\t\t</div>\t\t<div \tid='ButtonCursor_Left'>\t\t</div>\t\t<div \tid='ButtonCursor_Right'>\t\t</div>\t\t<div \tid='ButtonEnter'>\t\t</div>\t\t<div \tid='ButtonInfo'>\t\t</div>\t\t<div \tid='ButtonGuide'>\t\t</div>\t\t<div \tid='ButtonBack'>\t\t</div>\t\t<div \tid='ButtonExit'>\t\t</div>\t\t</div>\t\t<div id='areaSpace5'>\t\t</div>\t\t<div id='areaColorful'>\t\t<div \tid='ButtonRed'>\t\t</div>\t\t<div \tid='ButtonGreen'>\t\t</div>\t\t<div \tid='ButtonYellow'>\t\t</div>\t\t<div \tid='ButtonBlue'>\t\t</div>\t\t</div>\t\t<div id='areaSpace6'>\t\t</div>\t\t<div id='areaMultimedia'>\t\t<div \tid='ButtonRewind'>\t\t</div>\t\t<div \tid='ButtonPlay'>\t\t</div>\t\t<div \tid='ButtonForward'>\t\t</div>\t\t<div \tid='ButtonRecord'>\t\t</div>\t\t<div \tid='ButtonPause'>\t\t</div>\t\t<div \tid='ButtonStop'>\t\t</div>\t\t</div>\t\t<div id='areaSpace7'>\t\t</div>\t\t<div id='areaLogo'>\t\t<img src='images/control/logo.png' width='100%' height='100%' />\t\t</div>\t\t<div id='areaSpace8'>\t\t</div>";
$("#areaSpace1").hide();$("#areaPowerEject").hide();$("#areaSpace2").hide();$("#areaNumbers").hide();$("#areaSpace3").hide();$("#areaVolumeChannel").hide();$("#areaSpace4").hide();$("#areaInteractive").hide();$("#areaSpace5").hide();$("#areaColorful").hide();$("#areaSpace6").hide();$("#areaMultimedia").hide();$("#areaSpace7").hide();$("#areaLogo").hide();$("#areaSpace8").hide();this.setAreas();a="STart,Stop,Pause,Eject,Power,Key_1,Key_2,Key_3,Key_4,Key_5,Key_6,Key_7,Key_8,Key_9,Key_Hash,Key_0,Key_Star,Volume_Up,Channel_Up,Volume_Down,Channel_Down,Menu,Mute,Help,Info,Guide,Exit,Back,Enter,Cursor_Up,Cursor_Down,Cursor_Left,Cursor_Right,Red,Green,Yellow,Blue,Rewind,Play,Forward,Pause,Record,Stop".split(",");
for(button in a)eval("$('#Button' + imgButtons[button]).click($.proxy(function(){this.functionButton('"+a[button].toUpperCase()+"');},this));")}RemoteControl.prototype.setAreas=function(){var a="PowerEject,Numbers,VolumeChannel,Interactive,Colorful,Multimedia".split(",");for(area in a)if(this["p_area"+a[area]])this["setArea"+a[area]]()};
RemoteControl.prototype.functionButton=function(a){console.log(a);switch(a){case "PLAY":this.isPause?this.player.resume():this.player.start();break;case "STOP":this.player.stop();break;case "PAUSE":this.player.pause();this.isPause=!0;break;default:this.player.keyPress(a)}};var areas="PowerEject,Numbers,VolumeChannel,Interactive,Colorful,Multimedia".split(",");
for(area in areas)eval("RemoteControl.prototype['setArea"+areas[area]+"'] = function(){this['control"+areas[area]+"'] = !(this['control"+areas[area]+"']);$('#areaSpace"+(area+1)+"').toggle();$('#area"+areas[area]+"').toggle();if((this.controlPowerEject)||(this.controlNumbers)||(this.controlVolumeChannel)||(this.controlInteractive)||(this.controlColorful)||(this.controlMultimedia)){$('#areaSpace7').show();$('#areaLogo').show();$('#areaSpace8').show();}else{ $('#areaSpace7').hide();$('#areaLogo').hide();$('#areaSpace8').hide();}}");function Timer(a,b,c){c&&(this.manager=c);this.callback=b;this.timeLeft=a;this.id=this.startTime=null}Timer.prototype.timeout=function(){this.manager&&this.manager.remove(this);this.callback()};Timer.prototype.resume=function(){this.startTime=new Date;this.id=setTimeout($.proxy(function(){this.timeout()},this),this.timeLeft)};Timer.prototype.pause=function(){clearTimeout(this.id);this.timeLeft-=new Date-this.startTime};Timer.prototype.stop=function(){clearTimeout(this.id)};
function TimerManager(){this.timers=[]}TimerManager.prototype.add=function(a,b){this.timers.push(new Timer(a,b,this))};TimerManager.prototype.remove=function(a){this.timers.splice(this.timers.indexOf(a),1)};TimerManager.prototype.pauseAll=function(){for(i in this.timers)this.timers[i].pause()};TimerManager.prototype.resumeAll=function(){for(i in this.timers)this.timers[i].resume()};TimerManager.prototype.stopAll=function(){for(i in this.timers)this.timers[i].stop();this.timers=[]};function WebNclPlayer(a,b,c){c&&"/"!=c[c.length-1]&&(c+="/");var d=/[\/]*.+\//g;this.div=b;this.presentation={readyToPlay:!1,playRequested:!1,TIME_LIMIT:1E3,settingsNode:void 0,playerId:++WebNclPlayer.playerCount,playerDiv:b,getDivId:function(a,b){return"ncl"+this.playerId+(b||"")+"_"+(this.parser.referenceMap.instReuse[a]||a)},path:c||a&&d.exec(a)[0]||"",mediaPlayers:{"text/htm":{defaultPlayer:Html5Player},image:{defaultPlayer:Html5Player},"image/png":{defaultPlayer:Html5Player},"image/jpeg":{defaultPlayer:Html5Player},
"image/gif":{defaultPlayer:Html5Player},audio:{defaultPlayer:Html5Player},video:{defaultPlayer:Html5Player},"video/x-flv":{defaultPlayer:FlowPlayer},"text/css":void 0,"text/html":{defaultPlayer:Html5Player},"text/plain":{defaultPlayer:Html5Player},"application/x-ginga-NCLua":{defaultPlayer:LuaPlayer},"application/x-ginga-NCLet":void 0,"application/x-ginga-settings":{defaultPlayer:Html5Player},"text/xml":void 0,dummy:{defaultPlayer:Html5Player}},keyEvents:{}};b=this.presentation.playerId;this.presentation.bodyDiv=
"wncl_body"+b;this.presentation.settingsDiv="wncl_settings"+b;this.presentation.contextsDiv="wncl_contexts"+b;this.presentation.loadingDiv="wncl_loading"+b;this.presentation.playDiv="wncl_play"+b;this.presentation.endDiv="wncl_end"+b;this.presentation.keys={CURSOR_UP:38,CURSOR_DOWN:40,CURSOR_LEFT:37,CURSOR_RIGHT:39,ENTER:13,RED:81,GREEN:87,YELLOW:69,BLUE:82,KEY_0:96,KEY_1:97,KEY_2:98,KEY_3:99,KEY_4:100,KEY_5:101,KEY_6:102,KEY_7:103,KEY_8:104,KEY_9:105,BACK:90,EXIT:88,PLAY:67,STOP:86,PAUSE:66,RECORD:78,
POWER:65,REWIND:83,EJECT:68,MENU:77};this.presentation.reverseKeys=Array(120);for(var e in this.presentation.keys)this.presentation.reverseKeys[this.presentation.keys[e]]=e;this.presentation.keys.allCodes=[13,37,38,39,40,81,87,69,82,96,97,98,99,100,101,102,103,104,105,90,88,67,86,66,78,65,83,68];this.presentation.postEvent=$.proxy(this.postEvent,this);this.presentation.isPlaying=!1;this.presentation.isStopped=!0;this.presentation.playingElem=[];this.presentation.pausedElem=[];this.presentation.notifyLink=
$.proxy(this.nAction,this);this.presentation.lastMediaAborted=!1;this.presentation.parser=new Parser(this.presentation.path);a?this.presentation.parser.load(a,$.proxy(this.execute,this)):(a=document.URL.split("/"),a=a[a.length-1],this.presentation.parser.load(a,$.proxy(this.execute,this),this.div))}
WebNclPlayer.prototype.execute=function(a){var b=this.presentation.parser,c;for(c in b.parsers)console.log(["[",this.div,"]  ",c,":    LOAD: ",b.parsers[c].loadTime,"ms;   PARSE XML: ",b.parsers[c].xmlParse,"ms;   PARSE: ",b.parsers[c].parseTime,"ms"].join(""));var d,e;this.presentation.ncl=a.ncl;this.presentation.inputManager=new InputManager(this.presentation);this.presentation.systemSettings=new SystemSettings(this.presentation);a=$("#"+this.presentation.playerDiv);for(d in this.presentation.ncl.head.regionBase)for(e in this.presentation.ncl.head.regionBase[d].region)b=
{left:0,top:0,width:parseInt(a.css("width").split("px")[0]),height:parseInt(a.css("height").split("px")[0])},this.fixRegionBounds(this.presentation.ncl.head.regionBase[d].region[e],b);a.attr("tabindex",this.presentation.playerId);a.append($("<div></div>").attr({id:this.presentation.loadingDiv}).addClass("wncl_BlackDiv").hide().append($("<div></div>").addClass("wncl_loadingDiv"))).append($("<div></div>").attr({id:this.presentation.playDiv}).addClass("wncl_BlackDiv wncl_clickMe").append($("<div></div>").addClass("wncl_playDiv"))).append($("<div></div>").attr({id:this.presentation.endDiv}).addClass("wncl_BlackDiv wncl_clickMe").hide().append($("<div></div>").addClass("wncl_endDiv")));
a.append("<div id='"+this.presentation.settingsDiv+"'></div>");a.append("<div id='"+this.presentation.contextsDiv+"'></div>");this.presentation.context=new ContextPlayer(this.presentation.ncl.body,this.presentation);$("#"+this.presentation.playDiv).on("click",$.proxy(function(){this.presentation.context.isStopped?this.start():this.presentation.context.isPlaying||this.resume()},this));$("#"+this.presentation.endDiv).on("click",$.proxy(function(){this.start()},this));this.presentation.readyToPlay=!0;
this.presentation.playRequested&&this.start()};
...
"media"]]],required:["role","component"],optional:["interface","descriptor"]},content:{star:["bindParam"]}},bindParam:{attrs:{required:["name","value"]},content:{}},bindRule:{attrs:{reference_source:[[["constituent"],["media"]],[["rule"],["rule"]]],required:["constituent","rule"]},content:{}},body:{attrs:{reference_target:["id"],optional:["id"]},content:{star:"port,property,media,context,switch,link".split(",")}},causalConnector:{attrs:{reference_target:["id"],required:["id"]},content:{star:["connectorParam"],
custom:["simpleCondition","compoundCondition","simpleAction","compoundAction"],validate:function(a,b){0==a.simpleCondition&&0==a.compoundCondition?b.push({code:Logger.ERR_MISSING_TAG_ONEOF,params:["simpleCondition","compoundCondition"]}):0<a.simpleCondition&&0<a.compoundCondition?b.push({code:Logger.ERR_TOO_MANY_TAGS_ONEOF,params:["simpleCondition","compoundCondition"]}):1<a.simpleCondition?b.push({code:Logger.ERR_TOO_MANY_TAGS,params:["simpleCondition"]}):1<a.compoundCondition&&b.push({code:Logger.ERR_TOO_MANY_TAGS,
params:["compoundCondition"]});0==a.simpleAction&&0==a.compoundAction?b.push({code:Logger.ERR_MISSING_TAG_ONEOF,params:["simpleAction","compoundAction"]}):0<a.simpleAction&&0<a.compoundAction?b.push({code:Logger.ERR_TOO_MANY_TAGS_ONEOF,params:["simpleAction","compoundAction"]}):1<a.simpleAction?b.push({code:Logger.ERR_TOO_MANY_TAGS,params:["simpleAction"]}):1<a.compoundAction&&b.push({code:Logger.ERR_TOO_MANY_TAGS,params:["compoundAction"]})}}},compositeRule:{attrs:{required:["id","operator"]},content:{plusOneOf:["rule",
"compositeRule"]}},compoundAction:{attrs:{required:["operator"],optional:["delay"]},content:{plusOneOf:["simpleAction","compoundAction"]}},compoundCondition:{attrs:{required:["operator"],optional:["delay"]},content:{plusOneOf:["simpleCondition","compoundCondition"],star:["assessmentStatement","compoundStatement"]}},compoundStatement:{attrs:{required:["operator"],optional:["isNegated"]},content:{plusOneOf:["assessmentStatement","compoundStatement"]}},connectorBase:{attrs:{optional:["id"]},content:{star:["importBase",
"causalConnector"]}},connectorParam:{attrs:{reference_target:["name"],ref_group:!0,required:["name"],optional:["type"]},content:{}},context:{attrs:{reference_source:[[["refer"],["body","context"]]],reference_target:["id"],required:["id"],optional:["refer"]},content:{star:"port,property,media,context,switch,link".split(",")}},defaultComponent:{attrs:{reference_source:[[["component"],["context","media"]]],required:["component"]},content:{}},defaultDescriptor:{attrs:{reference_source:[[["descriptor"],
...
required:["alias","documentURI"],optional:["region","baseId"]},content:{}},importedDocumentBase:{attrs:{optional:["id"]},content:{plus:["importNCL"]}},importNCL:{attrs:{required:["alias","documentURI"]},content:{}},link:{attrs:{reference_source:[[["xconnector"],["causalConnector"]]],required:["xconnector"],optional:["id"]},content:{plus:["bind"],star:["linkParam"]}},linkParam:{attrs:{required:["name","value"]},content:{}},mapping:{attrs:{reference_source:[[["component"],["context","media"]]],required:["component"],
optional:["interface"]},content:{}},media:{attrs:{reference_source:[[["refer"],["media"]],[["descriptor"],["descriptor"]]],reference_target:["id"],required:["id"],optional:["instance","descriptor"],oneOf:["type","src","refer"]},content:{star:["area","property"]}},meta:{attrs:{required:["name","content"]},content:{}},metadata:{attrs:{},content:{}},ncl:{attrs:{optional:["id","title","xmlns"]},content:{optional:["head","body"]}},port:{attrs:{reference_source:[[["component"],["context","media"]]],reference_target:["id"],
required:["id","component"],optional:["interface"]},content:{}},property:{attrs:{reference_target:["name"],ref_group:!0,required:["name"],optional:["value"]},content:{}},region:{attrs:{reference_target:["id"],required:["id"],optional:"title,left,right,top,bottom,height,width,zIndex".split(",")},content:{star:["region"]}},regionBase:{attrs:{reference_target:["id"],optional:["id","device"]},content:{plusOneOf:["importBase","region"]}},rule:{attrs:{reference_source:[[["var"],["property"]]],required:["id",
"var","comparator","value"]},content:{}},ruleBase:{attrs:{optional:["id"]},content:{plusOneOf:["importBase","rule","compositeRule"]}},simpleAction:{attrs:{required:["role"],optional:"delay,eventType,actionType,value,min,max,qualifier,repeat,repeatDelay,duration,by".split(",")},content:{}},simpleCondition:{attrs:{required:["role"],optional:"delay,eventType,key,transition,min,max,qualifier".split(",")},content:{}},"switch":{attrs:{reference_source:[[["refer"],["switch"]]],reference_target:["id"],required:["id"],
optional:["refer"]},content:{optional:["defaultComponent"]}},switchPort:{attrs:{required:["id"]},content:{plus:["mapping"]}},transition:{attrs:{ref_multiple:!0,reference_target:["id"],required:["id","type"],optional:"subtype,dur,startProgress,endProgress,direction,fadeColor,horRepeat,vertRepeat,borderWidth,borderColor".split(",")},content:{}},transitionBase:{attrs:{optional:["id"]},content:{plusOneOf:["importBase","transition"]}},valueAssessment:{attrs:{required:["value"]},content:{}}};function Parser(a,b){this.referenceMap=new ReferenceMap(this);this.uniqueTable={};this.path=a;this.alias=b;this.url="";this.ncl=void 0;this.parsers={};this.__callback=void 0;this.loading=!1}Parser.prototype.load=function(a,b,c){if(this.loading)return!1;this.loading=!0;this.url=a;this.parsers[a]={parser:this,loadTime:0,parseTime:0,xmlParse:0};this.info=this.parsers[a];this.__callback=b;this.__load(a,$.proxy(this.parse,this),c);return!0};
Parser.prototype.__load=function(a,b,c){this.info.loadTime=new Date;$.ajax({type:"GET",url:a,context:{times:this.info,callback:b,div:c},dataType:c?"text":"xml",success:function(a){var b=this.times;b.loadTime=new Date-b.loadTime;b.xmlParse=new Date;a=c?$($.parseXML(a)).find("#"+this.div)[0]:a;b.xmlParse=new Date-b.xmlParse;this.callback(a)},error:function(a,b,c){a=this.times;a.loadTime=new Date-a.loadTime;Logger.error("PARSER",[b,c])}})};
Parser.prototype.parse=function(a){if(this.loading){var b=this.info;b.parseTime=new Date;this.ncl=this.createNode(a);this.uniqueTable.aliasList?(b.parseTime=new Date-b.parseTime,this.importNcl()):(this.referenceMap.createReferences(),b.parseTime=new Date-b.parseTime,this.__callback&&this.__callback(this),this.loading=!1)}};
Parser.prototype.importNcl=function(a){if(a)for(var b in a.parsers)this.parsers[[a.alias,"#",b].join("")]=a.parsers[b];a=this.uniqueTable.aliasList.splice(0,1);if(0<a.length)a[0].parser.load(this.path+a[0].url,$.proxy(this.importNcl,this));else{var a=new Date,c;this.referenceMap.createReferences();c=this.importBaseList.length;for(b=0;b<c;b++){var d=this.importBaseList[b],e=d.obj;if("regionBase"===e.__parent._type&&e.baseId){var f;if((f=d.parser.referenceMap.map[e.baseId])&&f.target)f=f.target.obj,
e.baseId=f,f._alias=e.alias,f.region&&(e.region?(e.region.region||(e.region.region=[]),$.merge(e.region.region,f.region)):this.ncl.head.regionBase.push(f));else{Logger.error(Logger.ERR_INVALID_ID_REFERENCE,[e.alias,"#",e.baseId].join(""),["importBase"]);return}}else if(e.region){var g,k;k=d.parser.ncl.head.regionBase;g=k.length;e.region.region||(e.region.region=[]);for(d=0;d<g;d++)$.merge(e.region.region,k[d].region)}else d.parser.ncl.head.regionBase&&$.merge(this.ncl.head.regionBase,d.parser.ncl.head.regionBase)}a=
new Date-a;this.info.parseTime+=a;this.loading=!1;this.__callback&&this.__callback(this)}};
Parser.prototype.createNode=function(a,b,c,d){b=b||"ncl";a=$(a).find("ncl"===b?"ncl":"> "+b);if(0===a.length)return!1;var e=[],f=Parser.nclStructureMap[b].attrs;f.required||(f.required=[]);f.optional||(f.optional=[]);f.oneOf||(f.oneOf=[]);var g=[].concat(f.required,f.optional,f.oneOf),f=Parser.nclStructureMap[b].content;f.optional||(f.optional=[]);f.one||(f.one=[]);f.plus||(f.plus=[]);f.plusOneOf||(f.plusOneOf=[]);f.star||(f.star=[]);f.custom||(f.custom=[]);var k=[].concat(f.optional,f.one,f.plus,
f.plusOneOf,f.star,f.custom),h=this;$(a).each(function(){var a={_type:b};for(i in g)a[g[i]]=$(this).attr(g[i]);var f=d+">"+b;a.id&&(f+="#"+a.id);h.parseAttributes(this,a,c);h.parseContent(this,a);for(i in k)a[k[i]]=h.createNode(this,k[i],a,f);e.push(a);if("ncl"===b)h.parseNCL(a,b,c,d);else if(b[0])h["parse"+b[0].toUpperCase()+b.slice(1,b.length)](a,b,c,d)});return-1===$.inArray(b,Parser.isNotArray)?e:e[0]};
Parser.prototype.parseAttributes=function(a,b,c){var d=$(a).get(0).attributes,e=b._type,f=Parser.nclStructureMap[e].attrs,g,k,h=[];for(k=0;k<d.length;k++)h.push(d.item(k).name);for(k in f.reference_source)for(g in f.reference_source[k][0])$(a).attr(f.reference_source[k][0][g])&&this.referenceMap.addSource(b,f.reference_source[k][0][g],f.reference_source[k][1]);for(g in f.reference_target)$(a).attr(f.reference_target[g])&&(d="focusIndex"===f.reference_target[g]?"focusIndex":e,this.referenceMap.addTarget(b,
$(a).attr(f.reference_target[g]),c,d)||Logger.error(Logger.ERR_DUPLICATED_ID,e,[f.reference_target[g],$(a).attr(f.reference_target[g]),$(a).parent().attr("id")]));for(g in f.required)if(a=$.inArray(f.required[g],h),-1==a)Logger.error(Logger.ERR_MISSING_ATTR,e,[f.required[g]]);else for(h[a]=0;a=-1!=$.inArray(f.required[g],h);)Logger.error(Logger.ERR_TOO_MANY_ATTRS,e,[f.required[g]]),h[a]=0;for(g in f.optional)if(a=$.inArray(f.optional[g],h),-1!=a)for(h[a]=0;a=-1!=$.inArray(f.optional[g],h);)Logger.error(Logger.ERR_TOO_MANY_ATTRS,
e,[f.required[g]]),h[a]=0;b=0==f.oneOf.length;for(g in f.oneOf)if(a=$.inArray(f.oneOf[g],h),-1!=a){b=!0;for(h[a]=0;a=-1!=$.inArray(f.oneOf[g],h);)Logger.error(Logger.ERR_TOO_MANY_ATTRS,e,[f.oneOf[g]]),h[a]=0}b||Logger.error(Logger.ERR_MISSING_ATTR_ONEOF,e,f.oneOf);for(g in h)0!=h[g]&&Logger.warning(Logger.WARN_INVALID_ATTR,e,[h[g]])};
...
c,[d.one[g]]),e[d.one[g]]=0;for(g in d.plus)0==e[d.plus[g]]&&Logger.error(Logger.ERR_MISSING_TAG,c,[d.plus[g]]),e[d.plus[g]]=0;f=0==d.plusOneOf.length;for(g in d.plusOneOf)0<e[d.plusOneOf[g]]&&(f=!0),e[d.plusOneOf[g]]=0;f||Logger.error(Logger.ERR_MISSING_TAG_ONEOF,c,d.plusOneOf);for(g in d.star)e[d.star[g]]=0;if(0<d.custom.length){d.validate(e,f=[]);for(var k in f)Logger.error(f[k].code,c,f[k].params);for(g in d.custom)e[d.custom[g]]=0}for(g in e)0<e[g]&&Logger.warning(Logger.WARN_INVALID_TAG,c,[g])};
function ReferenceMap(a){this.map={};this.instReuse=[];this.parser=a}ReferenceMap.prototype.addSource=function(a,b,c){var d=a[b];this.map[d]||(this.map[d]={sources:[]});this.map[d].sources.push({obj:a,attr:b,type:c});-1!==d.indexOf("#")&&(a=d.split("#"),this.map[d].target||(this.map[d].target={alias:a[0],id:a[1],obj:void 0,type:void 0,parents:[]}))};
ReferenceMap.prototype.addTarget=function(a,b,c,d){var e=c.id,f=!1;if(this.map[b])if(this.map[b].target)if("property"===d||"connectorParam"===d){if(this.map[b].target.parents[e])return!1}else return!1;else f=!0;else this.map[b]={sources:[]},f=!0;f&&(this.map[b].target={obj:a,type:d,parents:[],ptype:c._type});return this.map[b].target.parents[e]=!0};ReferenceMap.prototype.pop=function(a){return this.map[a]?this.map[a].target:!1};
ReferenceMap.prototype.createReferences=function(){for(var a in this.map)for(var b in this.map[a].sources){var c=this.map[a].sources[b],d=this.map[a].target;if(d&&d.alias){var e=this.parser.uniqueTable.alias;if(e&&e[d.alias]){var f=e[d.alias].parser.referenceMap.map[d.id];if((e[d.alias].allBases||e[d.alias][f.target.ptype])&&f)d.obj=f.target.obj,d.type=f.target.type,d.ptype=f.target.ptype}else Logger.error(ERR_INVALID_ALIAS,d.alias,[c.attr,c.obj[c.attr],c.type])}d&&d.obj&&-1!=$.inArray(this.map[a].target.type,
c.type)?"refer"==c.attr?"media"==c.obj._type&&(c.obj.descriptor=this.map[a].target.obj.descriptor,c.obj.src=this.map[a].target.obj.src,c.obj.type=this.map[a].target.obj.type,"new"!=c.obj.instance&&(this.instReuse[c.obj.id]=a)):c.obj[c.attr]=this.map[a].target.obj:Logger.error(Logger.ERR_INVALID_ID_REFERENCE,c.type,[c.attr,c.obj[c.attr],c.type])}};ContextPlayer.prototype=new Player;
...
ContextPlayer.prototype.bindLinks=function(){var a=this.node.port,b=this.node.link,c=this.handlers,d;for(d in a){var e=a[d],f="#"+this.presentation.getDivId(e.component.id),g=e.id,k;for(k in this.eventType){var h=this.eventType[k];if("attribution"!=h){var l=[h,k].join(".");$(f).on(l,{contextElement:this.htmlPlayer,interfaceId:g,eventName:l,portInterface:e["interface"]},function(a,b){if(b==a.data.portInterface){var c=$.Event(a.data.eventName);c.which=a.which;$(a.data.contextElement).trigger(c,[a.data.interfaceId])}})}}}for(d in b){var a=
b[d],m=a.xconnector,f={},g={},l=0,r="par",o=m.simpleCondition,s={},t={},n=[];if(m.connectorParam)for(d in m.connectorParam)s["$"+m.connectorParam[d].name]="";if(m.compoundCondition)for(d in o=m.compoundCondition[0].simpleCondition,1<o.length&&(l=Listener.listenerType[m.compoundCondition[0].operator.toUpperCase()]),m.compoundCondition[0].assessmentStatement){var j=m.compoundCondition[0].assessmentStatement[d];for(k in j.attributeAssessment)h=j.attributeAssessment[k],"attribution"==h.eventType&&(!h.attributeType||
"nodeProperty"==h.attributeType?t[h.role]={bindComponent:"",bindInterface:"",operator:j.comparator,value:j.valueAssessment.value,variable:ContextPlayer.isVariable(j.valueAssessment.value)}:console.warn("Eventos de tipos diferentes de attribution nao foram implementados para elementos do tipo AttributeAssessment"))}for(k in t)n.push(t[k]);for(d in o){var j=o[d],h=!1,e="",q=!1;"onSelection"===j.role&&j.key&&(ContextPlayer.isVariable(j.key)&&(h=!0),e=j.key,q=!0);g[j.role]={bindComponent:"",bindInterface:null,
eventType:this.eventType[j.role],flag:!1,keyUseVariable:h,keyDefaultValue:e,useKey:q}}o=m.simpleAction;m.compoundAction&&(r=m.compoundAction[0].operator?m.compoundAction[0].operator.toLowerCase():"seq",o=m.compoundAction[0].simpleAction);for(d in o)j=o[d],"set"==j.role?(m=!1,h="",j.value&&(ContextPlayer.isVariable(j.value)&&(m=!0),h=j.value),f[j.role]={binds:[],qualifier:o[d].qualifier,actionUseVariable:m,actionDefaultValue:h,pendingAcks:0}):f[j.role]={binds:[],qualifier:o[d].qualifier};m=[this];
r=new Listener(l,r,f,g,n,this.presentation,m);if(a.linkParam)for(d in a.linkParam)currentLinkParam=a.linkParam[d],s["$"+currentLinkParam.name]=currentLinkParam.value;for(d in a.bind)if(n=a.bind[d],q=n.component.id,l="#"+this.presentation.getDivId(q),o=n["interface"],f[n.role])h=null,j=f[n.role],"set"==n.role&&(j.actionUseVariable?(p=ContextPlayer.createLocalParamMap(n.bindParam),h=p[j.actionDefaultValue]?p[j.actionDefaultValue]:s[j.actionDefaultValue]):h=j.actionDefaultValue),this.context[q]&&o&&
m.push(this.context[q]),j.binds.push({bindComponent:l,bindInterface:o,value:h});else if(g[n.role]){e=g[n.role];e.bindComponent=l;e.bindInterface=o;var j=l,h=this.eventType[n.role],l=n.role,h=[h,l].join("."),q=[q,h].join("."),u=h+".triggerArray";if(e.useKey){var p=ContextPlayer.createLocalParamMap(n.bindParam);e.keyDefaultValue=p[e.keyDefaultValue]||s[e.keyDefaultValue];p=e.keyDefaultValue;$.isNumeric(p)&&(p="KEY_"+p);p in this.presentation.keys&&(e.keyDefaultValue=this.presentation.keys[p]);p="undefined";
e=j;if("context"==n.component._type&&o){for(d in n.component.port)if(e=n.component.port[d],portId=n.component.port[d].id,portId==o){p=e;break}e="#"+this.presentation.getDivId(p.component.id)}this.presentation.keyEvents[e]=!1}c[q]||(c[q]=!0,$(j).data(u)||$(j).data(u,[]),$(j).data(h)||$(j).data(h,[]),$(j).on(h,{componentDivId:j,bindName:h,eventName:l,triggerArrayName:u},function(a,b,c){var d=$(a.data.componentDivId).data(a.data.bindName),e;for(e in d){var f=d[e],g=f.flagMap[a.data.eventName];b==g.bindInterface&&
("selection"==a.type&&g.useKey?g.useKey&&a.which&&g.keyDefaultValue==a.which&&f.notifyEvent(a.data.eventName):f.notifyEvent(a.data.eventName))}ContextPlayer.executeTriggerArray($(a.data.componentDivId).data(a.data.triggerArrayName));c&&c()}));r.triggerBuffer=$(j).data(u);$(j).data(h).push(r)}else currentAssessment=t[n.role],currentAssessment.bindComponent=l,currentAssessment.bindInterface=o,currentAssessment.variable&&(p=ContextPlayer.createLocalParamMap(n.bindParam),currentAssessment.value=p[currentAssessment.value]?
p[currentAssessment.value]:s[currentAssessment.value])}};function FlowPlayer(a){this.p=a;this.htmlPlayer="#"+a.id;this.flowPlayer=void 0;a.createElement("<div class='player' id='"+a.id+"'></div>")}FlowPlayer.prototype.unload=function(){$(this.htmlPlayer).empty()};
...
FlowPlayer.prototype.start=function(){this.flowPlayer.play();console.log(this.flowPlayer)};FlowPlayer.prototype.stop=function(){this.flowPlayer.stop()};FlowPlayer.prototype.pause=function(){this.flowPlayer.pause()};FlowPlayer.prototype.resume=function(){this.flowPlayer.resume()};FlowPlayer.prototype.abort=function(){this.stop()};FlowPlayer.prototype.seek=function(a){this.flowPlayer.seek(a);this.flowPlayer.pause()};FlowPlayer.prototype.seekAndPlay=function(a){this.flowPlayer.seek(a);this.flowPlayer.resume()};function Html5Player(a){this.p=a;this.popcornPlayer=void 0;this.htmlPlayer="#"+a.id;this.loadTries=1;this.durationBind=this.duration=void 0;this.durationBinded=!1;this.durationMap={};this.endCallbacks=[];a.onChangeProperty.propertyMap={soundLevel:Player.propertyAction.OVERLOAD,fit:Player.propertyAction.OVERLOAD};switch(a.source.type.split("/")[0]){case "video":a.createElement("<video class='player' id='"+a.id+"'></video>");document.getElementById(this.p.id).addEventListener("error",$.proxy(this.mediaNotFound,
this),!0);break;case "audio":a.createElement("<audio class='player' id='"+a.id+"'></audio>");document.getElementById(this.p.id).addEventListener("error",$.proxy(this.mediaNotFound,this),!0);break;case "image":a.createElement("<img class='player' id='"+a.id+"'></img>");$(this.htmlPlayer).error($.proxy(this.mediaNotFound,this));break;case "application":switch(a.source.type){case "application/x-ginga-settings":a.createElement("<div class='player' id='"+a.id+"'></div>");break;case "application/x-ginga-NCLua":Logger.warning(Logger.WARN_NOT_IMPLEMENTED_YET,
"media",[a.source.type]);break;case "application/x-ginga-NCLet":Logger.warning(Logger.WARN_NOT_IMPLEMENTED_YET,"media",[a.source.type]);break;case "application/x-ginga-time":Logger.warning(Logger.WARN_NOT_IMPLEMENTED_YET,"media",[a.source.type])}break;case "text":switch(a.source.type){case "text/plain":case "text/html":a.createElement("<div class='player' id='"+a.id+"'></div>");break;case "text/css":Logger.warning(Logger.WARN_NOT_IMPLEMENTED_YET,"media",[a.source.type]);break;case "text/xml":Logger.warning(Logger.WARN_NOT_IMPLEMENTED_YET,
"media",[a.source.type])}break;case "dummy":a.createElement("<img class='player' id='"+a.id+"'></img>"),$(this.htmlPlayer).error($.proxy(this.mediaNotFound,this))}if(a.checkType(["video","audio"])){do this.popcornPlayer=new Popcorn(this.htmlPlayer);while(!this.popcornPlayer)}else if(a.checkType(["image","text","dummy"])){do Popcorn.player("baseplayer"),this.popcornPlayer=new Popcorn.baseplayer(this.htmlPlayer);while(!this.popcornPlayer)}this.playing=!1;this.playingArea=void 0;this.anchors=[];for(i in a.area){var b=
a.area[i].id;this.anchors[b]=a.area[i];this.anchors[b].temporal=a.area[i].begin||a.area[i].end||a.area[i].first||a.area[i].last?!0:!1;this.anchors[b].textual=a.area[i].beginText||a.area[i].endText||a.area[i].beginPosition||a.area[i].endPosition?!0:!1;this.anchors[b].spatial=a.area[i].coords?!0:!1;this.anchors[b].temporal&&(eval("this.exec(this.anchors[id].beginTime,$.proxy(function() {$(this.htmlPlayer).trigger('presentation.onBegin',['"+b+"']);},this));"),eval("this.exec(this.anchors[id].endTime,$.proxy(function() {this.stopArea('"+
b+"');},this));"));if(this.anchors[b].spatial&&!this.anchors[b]._ignore){var c=this.anchors[b].coords.split(",");for(i in c){var d=c[i].split("%");1<d.length&&(c[i]='Math.round(parseInt($(this.htmlPlayer).css("'+(i%2?"height":"width")+'").split("px")[0]) * '+parseFloat(d[0])/100+")")}this.anchors[b].calculatedCoords=c;this.p.checkType(["image"])||Logger.warning(Logger.WARN_NOT_IMPLEMENTED_YET,"area",["coords",a.source.type])}}this.exec("end",$.proxy(function(){for(i in this.anchors)this.anchors[i].temporal&&
this.stopArea(i)},this))}Html5Player.prototype.stopArea=function(a){this.anchors[a].started?(this.anchors[a].started=!1,$(this.htmlPlayer).trigger("stop",[a])):$(this.htmlPlayer).trigger("presentation.onEnd",[a])};Html5Player.prototype.unload=function(){$(this.htmlPlayer).empty()};Html5Player.prototype.mediaNotFound=function(){this.loadTries--;0>=this.loadTries&&Logger.warning(Logger.WARN_MEDIA_NOT_FOUND,this.p.id,[this.p.source.url])};
Html5Player.prototype.load=function(a){this.p.source.url=a;this.loadTries=1;var b=this.p.source.type.split("/")[0];switch(b){case "video":case "audio":var c=a.split(".");if(1<c.length){var c=c[c.length-1],a=a.substr(0,a.lastIndexOf(".")),d="video"==b?["webm","mp4","ogg"]:["mp3","ogg"];d.sort(function(a,b){return b==c});this.loadTries=d.length;for(i in d)$(this.htmlPlayer).append('<source type="'+b+"/"+d[i]+'" src="'+a+"."+d[i]+'"></source>')}else $(this.htmlPlayer).append('<source type="'+this.p.source.type+
'" src="'+a+'"></source>');break;case "image":$(this.htmlPlayer).attr("src",a);break;case "text":this.p.checkType(["text/plain","text/html"])&&$.ajax({type:"GET",url:a,dataType:"text",success:$.proxy(function(a){this.textData=a;this.loadTextData()},this),error:$.proxy(this.mediaNotFound,this)})}};
Html5Player.prototype.exec=function(a,b){if(this.popcornPlayer)if("begin"==a)$(this.htmlPlayer).on("play",b);else"end"==a?(this.endCallbacks.push(b),$(this.htmlPlayer).on("ended",b)):this.popcornPlayer.cue(a,b)};
...
b:(e=a,Logger.warning(Logger.WARN_INVALID_AREA,"area",["endText","endPosition"])));e&&$(this.htmlPlayer).append(e.replace(/\n/g,"<br/>"))};function LuaPlayer(a){console.log("constructor lua: "+a.id);this.p=a;this.htmlPlayer="#"+a.id;this.luajscode=void 0;this.persitent=new libPersistent(!1);this.canvas_objects=[];this.events=new libEvents(this);this.broker=new libBroker(this);this.id=0;this.arrayUsers=[];this.isHandlingEvent=!1;a.createElement("<div class='player' id='"+a.id+"'></div>");this.loaded=!1;this.p.onChangeProperty={};this.p.onChangeProperty.defaultAction=Player.propertyAction.OVERRIDE;this.p.onChangeProperty.propertyMap={};
this.p.onChangeProperty.propertyMap.width=Player.propertyAction.IGNORE;this.p.onChangeProperty.propertyMap.height=Player.propertyAction.IGNORE;this.p.onChangeProperty.propertyMap.left=Player.propertyAction.IGNORE;this.p.onChangeProperty.propertyMap.top=Player.propertyAction.IGNORE;this.pathlua="";a.enableKeyEvents();console.log(a.id)}LuaPlayer.prototype.unload=function(){$(this.htmlPlayer).empty()};
LuaPlayer.prototype.load=function(a){var b=a.split("/");this.pathLua=b[0]+"/"+b[1]+"/";console.log(this.pathLua);$.ajax({type:"GET",url:a,dataType:"text",async:!1,success:$.proxy(function(a){this.luajscode=lua_load("canvas = libCanvas.init();\n"+a)},this),error:function(){console.log("error to load file")}});this.bindlibs()};LuaPlayer.prototype.exec=function(a){console.log("exec lua: "+a)};
LuaPlayer.prototype.start=function(a){console.log("start lua: "+a);if(!1===this.loaded){this.loaded=!0;var b=lua_newtable();b.str["class"]="ncl";b.str.type="presentation";b.str.action="start";this.eventQueue(b,!0);lua_call(this.luajscode);this.events.handlers&&this.callHandlers()}void 0!=a&&(b=lua_newtable(),b.str["class"]="ncl",b.str.type="presentation",b.str.action="start",b.str.label=a,this.eventQueue(b))};
LuaPlayer.prototype.stop=function(){console.log("stop lua");if(this.events.handlers){var a=lua_newtable();a.str["class"]="ncl";a.str.type="presentation";a.str.action="stop";this.eventQueue(a)}};LuaPlayer.prototype.pause=function(){console.log("pause lua");if(this.events.handlers){var a=lua_newtable();a.str["class"]="ncl";a.str.type="presentation";a.str.action="pause";this.eventQueue(a)}};
LuaPlayer.prototype.resume=function(){console.log("resume lua");if(this.events.handlers){var a=lua_newtable();a.str["class"]="ncl";a.str.type="presentation";a.str.action="resume";this.eventQueue(a)}};LuaPlayer.prototype.abort=function(){console.log("abort lua");if(this.events.handlers){var a=lua_newtable();a.str["class"]="ncl";a.str.type="presentation";a.str.action="abort";this.eventQueue(a)}};LuaPlayer.prototype.seek=function(){console.log("seek lua");this.eventQueue(evt)};
LuaPlayer.prototype.seekAndPlay=function(){console.log("seek and play lua")};LuaPlayer.prototype.keyEventHandler=function(a){if(this.events.handlers){var b=lua_newtable();b.str["class"]="key";b.str.type=a.type;b.str.key=a.key;this.eventQueue(b)}};LuaPlayer.prototype.setProperty=function(a,b){if(this.events.handlers){var c=lua_newtable();c.str["class"]="ncl";c.str.type="attribution";c.str.action="start";c.str.name=a;c.str.value=b;this.eventQueue(c)}};
LuaPlayer.prototype.bindlibs=function(){lua_libs.libCanvas={variable:{id:this.id,p:this.p,canvas_objects:this.canvas_objects,pathLua:this.pathLua}};lua_libs.libCanvas.init=$.proxy(function(){try{var a=document.createElement("canvas");a.id="mycanvas_"+this.variable.id;a.width=this.variable.p.getProperty("width").split("px")[0];a.height=this.variable.p.getProperty("height").split("px")[0];$("#"+this.variable.p.id).append(a);var b=a.getContext("2d"),c=new libCanvas(b);console.log("init");this.variable.canvas_objects[this.variable.id]=
c}catch(d){console.warn("region has to be defined")}a=lua_newtable();a.str.id=this.variable.id;a.str["new"]=$.proxy(function(a,b,c){void 0===c?(objCanvas=this.variable.canvas_objects[a.str.id],newObject=objCanvas.newImage(this.variable.pathLua+b),this.variable.id+=1,this.variable.canvas_objects[this.variable.id]=newObject,a=$.extend(!0,{},a),a.str.id=this.variable.id):(objCanvas=this.variable.canvas_objects[a.str.id],newObject=objCanvas.newCanvas(b,c),this.variable.id+=1,a=$.extend(!0,{},a),a.str.id=
this.variable.id,this.variable.canvas_objects[this.variable.id]=newObject);return[a]},this);a.str.attrSize=$.proxy(function(a){return 0==this.variable.canvas_objects.length?(console.warn("This lua has no canvas."),[0,0]):this.variable.canvas_objects[a.str.id].attrSize()},this);a.str.attrColor=$.proxy(function(a,b,c,d,h){if(0==this.variable.canvas_objects.length)console.warn("This lua has no canvas.");else{a=this.variable.canvas_objects[a.str.id];if(void 0===b&void 0===c&void 0===d&void 0===h)return[a.getColor()];
a.attrColor(b,c,d,h)}},this);a.str.drawLine=$.proxy(function(a,b,c,d,h){0==this.variable.canvas_objects.length?console.warn("This lua has no canvas."):this.variable.canvas_objects[a.str.id].drawLine(b,c,d,h)},this);a.str.drawRect=$.proxy(function(a,b,c,d,h,l){0==this.variable.canvas_objects.length?console.warn("This lua has no canvas."):this.variable.canvas_objects[a.str.id].drawRect(b,c,d,h,l)},this);a.str.drawText=$.proxy(function(a,b,c,d){0==this.variable.canvas_objects.length?console.warn("This lua has no canvas."):
this.variable.canvas_objects[a.str.id].drawText(b,c,d)},this);a.str.measureText=$.proxy(function(a,b){return 0==this.variable.canvas_objects.length?(console.warn("This lua has no canvas."),[0,0]):[this.variable.canvas_objects[a.str.id].measureTextLua(b)]},this);a.str.attrFont=$.proxy(function(a,b,c,d){if(0==this.variable.canvas_objects.length)console.warn("This lua has no canvas.");else{a=this.variable.canvas_objects[a.str.id];if(void 0===b&void 0===c&void 0===d)return[a.getFont()];a.attrText(b,c,
d)}},this);a.str.attrCrop=$.proxy(function(a,b,c,d,h){if(0==this.variable.canvas_objects.length)console.warn("This lua has no canvas.");else{a=this.variable.canvas_objects[a.str.id];if(void 0===b&void 0===c&void 0===d&void 0===h)return[a.getCrop()];a.attrCrop(b,c,d,h)}},this);a.str.compose=$.proxy(function(a,b,c,d){0==this.variable.canvas_objects.length?console.warn("This lua has no canvas."):this.variable.canvas_objects[a.str.id].compose(b,c,this.variable.canvas_objects[d.str.id])},this);a.str.flush=
$.proxy(function(a){0==this.variable.canvas_objects.length?console.warn("This lua has no canvas."):this.variable.canvas_objects[a.str.id].flush()},this);a.str.attrClip=$.proxy(function(a,b,c,d,h){if(0==this.variable.canvas_objects.length)console.warn("This lua has no canvas.");else{a=this.variable.canvas_objects[a.str.id];if(void 0===b&void 0===c&void 0===d&void 0===h)return[a.getClip()];a.attrClip(b,c,d,h)}},this);return[a]},lua_libs.libCanvas);lua_libs.persistent={set:$.proxy(function(a,b,c){console.log(this);
this.persitent.storeField(a,b,c)},this),get:$.proxy(function(a){return[this.persitent.recoverField(a)]},this)};lua_libs.event={post:$.proxy(function(a,b){this.events.post(a,b)},this),register:$.proxy(function(a){this.events.register(a)},this),unregister:$.proxy(function(a){this.events.unregister(a)},this),timer:$.proxy(function(a,b){this.events.timer(a,b)},this),uptime:$.proxy(function(){return[this.events.uptime()]},this)};lua_libs.broker={init:$.proxy(function(a,b){this.broker.init(a,b)},this),
post:$.proxy(function(a,b){this.broker.post(a,b)},this),register:$.proxy(function(a,b){this.broker.register(a,b)},this),unregister:$.proxy(function(a){this.broker.unregister(a)},this)}};
...
!1)};
MediaPlayer.prototype.create=function(a){a.descriptor&&(this.transIn=a.descriptor.transIn,this.transOut=a.descriptor.transOut,this.explicitDur=a.descriptor.explicitDur);if(a.type)this.type=a.type;else if(a.src){var b=a.src.split(".");this.type=this.mediaTypes[b[b.length-1]]}else this.type="dummy";this.htmlPlayer="#"+this.divId;this.htmlPlayerBkg="#"+this.presentation.getDivId(a.id,"bkg");this.region="application/x-ginga-settings"===this.type?"#"+this.presentation.settingsDiv:"#"+this.presentation.playerDiv;"application/x-ginga-settings"==
this.type&&(this.presentation.settingsNode=this);if(!(a.refer&&"new"!=a.instance)){$(this.region).append("<div class='playerBkg' id='"+this.presentation.getDivId(a.id,"bkg")+"'></div>");this.playerSettings={source:{type:this.type,url:this.presentation.path+a.src},onChangeProperty:{defaultAction:Player.propertyAction.IGNORE,propertyMap:{}},id:this.divId,parentId:this.presentation.getDivId(a.id,"bkg"),createElement:$.proxy(this.createElement,this),checkType:$.proxy(this.checkType,this),getProperty:$.proxy(this.getProperty,
this),setProperty:$.proxy(this.setProperty,this),postEvent:this.presentation.postEvent,enableKeyEvents:$.proxy(this.enableKeyEvents,this),area:a.area};var c,b=this.presentation.mediaPlayers;a.descriptor&&a.descriptor.player&&("function"==eval("typeof "+a.descriptor.player)&&"object"==eval("typeof "+a.descriptor.player+".prototype")?c=eval(a.descriptor.player):(Logger.error(Logger.WARN_MEDIAPLAYER_NOT_FOUND,"Descriptor Player",[a.descriptor.player]),this.player={}));!c&&b[this.type]&&(c=b[this.type][a._ext]||
b[this.type].defaultPlayer);if(c){this.player=new c(this.playerSettings);this.playerName=c.name;c="load,unload,exec,start,stop,pause,resume,abort,seek,seekAndPlay,setProperty,getDuration,keyEventHandler".split(",");for(var d in c)this.player[c[d]]||(this.player[c[d]]=$.proxy(function(){Logger.error(Logger.ERR_MEDIAPLAYER_METHOD_NOTFOUND,this.playerName,[this.fname])},{playerName:this.playerName,fname:c[d]}))}else Logger.error(Logger.ERR_MEDIAPLAYER_NOPLAYER,this.type,[]),this.player={};$(this.htmlPlayerBkg).css("display",
"none");this.load(a.src);this.data=$(this.htmlPlayer).data();this.player.exec&&this.player.exec("end",$.proxy(function(){this.playingArea?($(this.htmlPlayer).trigger("presentation.onEnd"),this.playingArea=void 0):this.stop()},this));$(this.htmlPlayer).data("property",[]);if(a.descriptor)for(d in a.descriptor.explicitDur&&this.setProperty("explicitDur",a.descriptor.explicitDur),a.descriptor.region&&(this.setProperty("zIndex",a.descriptor.region.zIndex),this.setProperty("width",a.descriptor.region.width),
this.setProperty("height",a.descriptor.region.height),this.setProperty("bottom",a.descriptor.region.bottom),this.setProperty("top",a.descriptor.region.top),this.setProperty("right",a.descriptor.region.right),this.setProperty("left",a.descriptor.region.left),this.setProperty("title",a.descriptor.region.title)),a.descriptor.descriptorParam)this.setProperty(a.descriptor.descriptorParam[d].name,a.descriptor.descriptorParam[d].value);c=[];for(d in a.property)if(a.property[d].value)switch(a.property[d].name){case "bounds":case "top":case "left":case "bottom":case "right":case "height":case "width":c.push({name:a.property[d].name,
value:a.property[d].value});break;default:this.setProperty(a.property[d].name,a.property[d].value)}if(0<c.length){a={left:0,top:0,width:parseInt($("#"+this.presentation.playerDiv).css("width").split("px")[0]),height:parseInt($("#"+this.presentation.playerDiv).css("height").split("px")[0])};b={left:null,right:null,top:null,bottom:null,width:null,height:null};this.node.descriptor&&this.node.descriptor.region&&(a.left=this.node.descriptor.region._parent.left?parseInt(this.node.descriptor.region._parent.left.split("px")[0]):
0,a.top=this.node.descriptor.region._parent.top?parseInt(this.node.descriptor.region._parent.top.split("px")[0]):0,a.width=this.node.descriptor.region._parent.width?parseInt(this.node.descriptor.region._parent.width.split("px")[0]):parseInt($("#"+this.presentation.playerDiv).css("width").split("px")[0]),a.height=this.node.descriptor.region._parent.height?parseInt(this.node.descriptor.region._parent.height.split("px")[0]):parseInt($("#"+this.presentation.playerDiv).css("height").split("px")[0]),b.left=
(this.node.descriptor.region.left.split("px")[0]-a.left).toString(),b.top=(this.node.descriptor.region.top.split("px")[0]-a.top).toString(),b.width=this.node.descriptor.region.width,b.height=this.node.descriptor.region.height);for(d in c){var e=c[d].name,f=c[d].value;switch(e){case "bounds":f=f.split(",");b.left=f[0];b.top=f[1];b.width=f[2];b.height=f[3];break;case "top":case "left":case "bottom":case "right":case "height":case "width":b[e]=f}}WebNclPlayer.prototype.fixRegionBounds(b,a);for(e in b)(f=
b[e])&&null!=f&&this.setProperty(e,f)}this.player.exec("end",$.proxy(function(){this.playingArea?($(this.htmlPlayer).trigger("presentation.onEnd"),this.playingArea=void 0):this.stop()},this));this.bindEvents();$(this.htmlPlayer).data("player",this)}};MediaPlayer.prototype.load=function(a){a=this.presentation.path+a;this.player.unload(a);this.player.load(a)};
...
parseInt($(this.htmlPlayer).css("height").split("px")[0])+"px",e.top=$(this.htmlPlayer).css("top"))}if("out"==b)for(i in d)g=d[i],d[i]=e[i],e[i]=g;break;case "irisWipe":a.subtype=a.subtype||"rectangle";f=this.htmlPlayerBkg;if("rectangle"==a.subtype){var g=parseInt($(this.htmlPlayer).css("left").split("px")[0]),k=parseInt($(this.htmlPlayer).css("top").split("px")[0]),h=parseInt($(this.htmlPlayer).css("width").split("px")[0]),l=parseInt($(this.htmlPlayer).css("height").split("px")[0]);d.width="0px";
d.height="0px";d.left=g+h/2+"px";d.top=k+l/2+"px";e.width=h+"px";e.height=l+"px";e.left=g+"px";e.top=k+"px";if("out"==b)for(i in d)g=d[i],d[i]=e[i],e[i]=g}else Logger.warning(Logger.WARN_NOT_IMPLEMENTED_YET,"transition",[a.type,a.subtype]);break;case "snakeWipe":case "clockWipe":Logger.warning(Logger.WARN_NOT_IMPLEMENTED_YET,"transition",[a.type])}$(f).css(d);$(f).animate(e,c);$(f).dequeue()};
